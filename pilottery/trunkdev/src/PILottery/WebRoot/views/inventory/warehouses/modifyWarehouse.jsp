	...
	<form action="warehouses.do?method=modifyWarehouse" id="modifyWarehouseForm" method="POST">
		<div class="pop-body">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:25px;">
				...
				<tr>
					<td width="25%" align="right">Institution Code：</td>
					<td width="35%" align="center">
				...
				<tr>
					<td width="25%" align="right">Institution Name：</td>
					<td width="35%" align="center">
				...
				<tr>
					<td width="25%" align="right">Contact Phone：</td>
					<td width="35%" align="center">
				...
				<tr>
					<td width="25%" align="right">Director：</td>
					<td width="35%" align="center">
				...
				<tr>
					<td width="25%" align="right">Warehouse Status：</td>
					<td width="35%" align="center">
						<c:if test="${details.status == 1}">
							<input id="status" name="status" class="text-big-noedit" value="Operational" readonly="readonly"></input>
						</c:if>
						<c:if test="${details.status == 2}">
							<input id="status" name="status" class="text-big-noedit" value="Deleted" readonly="readonly"></input>
						</c:if>
						<c:if test="${details.status == 3}">
							<input id="status" name="status" class="text-big-noedit" value="Checking" readonly="readonly"></input>
						</c:if>
					</td>
					<td><span id="statusTip" class="tip_init">*</span></td>
				</tr>
				<tr>
					<td width="25%" align="right">Warehouse Address：</td>
					<td width="35%" align="center">
			...
			<div style="padding:0 20px; margin-top:10px;margin-bottom:30px;">
				<table style="width:100%" class="datatable">
					<tr>
						<th width="1px">&nbsp;</th>
						<th width="21%">Manager Code</th>
						<th width="2%">|</th>
						<th width="21%">Manager Name</th>
						<th width="2%">|</th>
						<th width="21%">Real Name</th>
						<th width="2%">|</th>
						<th width="21%">Contact Phone</th>
						<th width="2%">|</th>
						<th width="*%" style="padding-left:9px;">M</th>
					</tr>
