...
$(document).ready(function(){
    ...
    // 初始化用户类型
		...
		var 	jsonstr
		        ...
		        var url='goodsReceipts.do?method=getReturnPlanInfoBycode&returnNo='+returnNo;
				$.ajax({
					url : url,
					dataType : "json",
					async : false,
	 ...
	 $("#okbtn").click(function(){ 
		 if(parseInt(rownum)>0){
			 ...
			 switch_obj("okbtn","waitBtn");
			  $("#goodReceiptParamt").attr("action","goodsReceipts.do?method=goodsReturnSecond");
...
<form method="post" action=""  id="goodReceiptParamt" name="goodReceiptParamt" onkeydown="if(event.keyCode==13){return false;}">
 ...
 <input type="hidden" name="operType" value="2">
  ...
  <input type="hidden" name="returnNo" id="returnNo" value="${returnNo}">
          ...
          <td ><div class="tab" >
              <div class="tabn">
                <table  border="0"  cellpadding="0" cellspacing="0" width="100%" valign="top">
                  ...
                  <tr>
                    <td><div class="nr">
                    <div style="margin-bottom:20px;"><span class="dazit" style="font-size:18px;">Retrurn Code :<span class="hz1">${returnNo}</span></span><span class="dazit" style="font-size:18px;">Already in storage :<span class="hz1"><fmt:formatNumber value='${sumtickts}'  type='number'/>(Tickets)</span></span></div>
                      ...
                      <div class="nr">
                        <div class="title-mbx">Return incoming details </div>
                      ...
                      <div class="nr">
                        <div class="title-mbx">Details of Goods Return Information</div>
                      </div>
