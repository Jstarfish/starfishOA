    ...
    <div id="bodyDiv">
        ...
        <input type="hidden" name="accountType" id="accountType" value="${obj.accountType}">
            <tr class="dataRow">
                ...
                <td width="1%">&nbsp;</td>
                <td style="width:8%"><c:forEach var="item" items="${getApproveAccountType}"><c:if test="${!empty obj }"><c:if test="${obj.accountType==item.key }">${item.value}</c:if></c:if></c:forEach></td>
                <td width="1%">&nbsp;</td>
