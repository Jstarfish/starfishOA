    ...
    <div class="queryDiv">
        <form action="saleReport.do?method=getGameSalesReport" id="queryForm" method="post">
            <div class="left">
                ...
                <span>Date:
                    <input name="beginDate" id="beginDate" value="${form.beginDate }" class="Wdate text-normal" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true,maxDate:'#F{$dp.$D(\'endDate\')||\'%y-%M-{%d}\'}'})"/> 
                    	-
                    <input name="endDate" id="endDate" value="${form.endDate }" class="Wdate text-normal" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true,minDate:'#F{$dp.$D(\'beginDate\')}',maxDate:'%y-%M-{%d}'})"/>
                </span>
