...
<body>
    <!-- 顶部标题块 -->
    <div id="title">Institution Inventory Daily Report</div>
    
    <!-- 查询条件块 -->
    <div class="queryDiv">
        <form action="saleReport.do?method=institutionInventoryDaliyReport" id="queryForm" method="post">
            <div class="left">
            	<span>Institution:
            	 <select class="select-normal" name="institutionCode" >
            			<option value="">--All--</option>
                   	   <c:forEach var="obj" items="${institutionList}" varStatus="plan">
                   	   		<c:if test="${obj.institutionCode != '00'}">
             ...
             <div style="overflow: right;">
	        	<span style="position: absolute;right: 80px;">
	        		<input type="hidden" id="reportTitle" name="reportTitle" value="Institution Inventory Daily Report">
                ...
                <td>
                    <table class="datatable" id="exportPdf">
                        <tr class="headRow">
                            ...
                            <td width="1%" noExp="true">|</td>
                            <td style="width:9%">Beginning(tickets)</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:9%">Receipts(tickets)</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:9%">Issue(tickets)</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:9%">Sales(tickets)</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:9%">Return(tickets)</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:9%">Damaged(tickets)</td>
                            <td width="1%" noExp="true">|</td>
    ...
    <div id="bodyDiv">
        ...
        <c:forEach var="obj" items="${list}">
            <tr class="dataRow">
                ...
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:9%">${obj.institutionName }</td>
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:9%;">${obj.planName}</td>
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:9%;text-align: right;"><fmt:formatNumber value="${obj.beginTickets }"/></td>
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:9%;text-align: right;"><fmt:formatNumber value="${obj.receiptTickets }"/></td>
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:9%;text-align: right;"><fmt:formatNumber value="${obj.issueTickets }"/></td>
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:9%;text-align: right;"><fmt:formatNumber value="${obj.salesTickets }"/></td>
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:9%;text-align: right;"><fmt:formatNumber value="${obj.returnTickets }"/></td>
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:9%;text-align: right;"><fmt:formatNumber value="${obj.damageTickets}"/></td>
                <td width="1%" noExp="true">&nbsp;</td>
