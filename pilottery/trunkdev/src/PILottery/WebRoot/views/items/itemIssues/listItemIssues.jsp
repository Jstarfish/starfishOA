        ...
        <table class="datatable">
        	<c:forEach var="data" items="${itemIssueList}" varStatus="status">
        		<tr class="dataRow">
        			...
        			<td width="1%">&nbsp;</td>
        			<td style="width:*%">
	                    <span><a href="#" onclick="showBox('item.do?method=itemIssueDetails&iiNo=${data.iiNo}&operAdminName=${data.operAdminName}&receiveOrgName=${data.receiveOrgName}&sendOrgName=${data.sendOrgName}&sendWhName=${data.sendWhName}','Item Issue Details', 550, 800);">Details</a></span>&nbsp;|
