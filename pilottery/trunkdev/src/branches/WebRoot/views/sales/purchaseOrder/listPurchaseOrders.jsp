...
function newPurchaseOrder(){
	showBox('order.do?method=initPurchaseOrder','New Purchase Order',650,800);
}
...
function editOrder(orderNo){
	showBox('order.do?method=initPurchaseOrderEdit&purchaseOrderNo=' + orderNo,'Edit Purchase Order',650,800);
}
