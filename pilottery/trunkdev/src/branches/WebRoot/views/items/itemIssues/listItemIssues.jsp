    ...
    <div class="queryDiv">
        <form action="item.do?method=listGoodsIssues" method="POST" id="itemIssueQueryForm">
            <div class="left">
				...
				<span>Issue Date: <input id="issueDate" name="issueDate" value="${itemIssueQueryForm.issueDate}" class="Wdate text-normal" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true,isShowClear:true,isShowToday:true})" maxlength="40"/></span>
				<span>Warehouse:
            ...
            <div class="right">
                <table width="260" border="0" cellspacing="0" cellpadding="0">
                    <tr style="height:50px;line-height:50px">
                        <td align="right">
                            <input type="button" value="New Item Issue" onclick="showBox('item.do?method=addItemIssueInit','New Item Issue', 600, 800);" class="button-normal"></input>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <table class="datatable">
        	<c:forEach var="data" items="${itemIssueList}" varStatus="status">
        		<tr class="dataRow">
        			...
        			<td width="1%">&nbsp;</td>
        			<td style="width:*%">
	                    <span><a href="#" onclick="showBox('item.do?method=itemIssueDetails&iiNo=${data.iiNo}&operAdminName=${data.operAdminName}&receiveOrgName=${data.receiveOrgName}&sendOrgName=${data.sendOrgName}&sendWhName=${data.sendWhName}','Item Issue Details', 600, 800);">Details</a></span>&nbsp;|
	                    <span><a href="#" onclick="showPage('item.do?method=printItemIssueSlip&iiNo=${data.iiNo}&receiveOrgName=${data.receiveOrgName}&sendOrgName=${data.sendOrgName}&sendWhName=${data.sendWhName}','Item Issue Slip');">Print</a></span>
                	</td>
        		</tr>
        	</c:forEach>
        </table>
