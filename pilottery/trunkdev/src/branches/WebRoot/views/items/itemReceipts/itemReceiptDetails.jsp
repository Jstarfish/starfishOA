...
<title>Item Receipt Details</title>
...
<body style="text-align:center">
	<div class="pop-body">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td width="30%" align="right">Receipt Code：</td>
				<td width="20%" align="left">${receiptCode}</td>
				<td width="25%" align="right">&nbsp;</td>
				<td width="25%" align="left">&nbsp;</td>
			</tr>
			<tr>
				<td width="30%" align="right">Warehouse：</td>
				<td width="30%" align="left">${receiptWhName}</td>
				<td width="25%" align="right">&nbsp;</td>
				<td width="25%" align="left">&nbsp;</td>
			</tr>
			<tr>
				<td width="30%" align="right">Processed By：</td>
				<td width="30%" align="left">${createAdminName}</td>
				<td width="25%" align="right">&nbsp;</td>
				<td width="25%" align="left">&nbsp;</td>
			</tr>
		</table>
