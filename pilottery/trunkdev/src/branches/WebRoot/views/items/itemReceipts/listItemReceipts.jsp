            ...
            <div class="right">
                <table width="260" border="0" cellspacing="0" cellpadding="0">
                    <tr style="height:50px;line-height:50px">
                        <td align="right">
                            <input type="button" value="New Item Receipt" onclick="showBox('item.do?method=addItemReceiptInit','New Item Receipt', 600, 800);" class="button-normal"></input>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <table class="datatable">
        	<c:forEach var="data" items="${itemReceiptList}" varStatus="status">
            	<tr class="dataRow">
                	...
                	<td width="1%">&nbsp;</td>
                	<td style="width:*%">
                    	<span><a href="#" onclick="showBox('item.do?method=itemReceiptDetails&irNo=${data.irNo}&receiveWhName=${data.receiveWhName}&createAdminName=${data.createAdminName}','Item Receipt Details', 600, 800);">Details</a></span>&nbsp;|
