													...
													<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top: 30px;">
														<tr>
															<td width="30%" style="border-bottom: 1px dashed #ccc; padding-bottom: 15px;" class="hoz">
																差异 :<span class="lz2"> <fmt:formatNumber value='${result.cbeforeNum-result.cafterNum}'  type='number'/></span>票
															</td>
															<td width="30%" style="border-bottom: 1px dashed #ccc; padding-bottom: 15px;">
																盘点前 : <span class="lz2">  <fmt:formatNumber value='${result.cbeforeNum}'  type='number'/></span>票
															</td>
															<td style="border-bottom: 1px dashed #ccc; padding-bottom: 15px;">
																盘点后 : <span class="lz2"> <fmt:formatNumber value='${result.cafterNum}'  type='number'/></span>票
															</td>
														</tr>
														<tr>
															<td>
																利润和损失: <span class="lz2"><fmt:formatNumber value='${result.cbeforeNum-result.cafterNum}'  type='number'/></span>票									
															</td>
															<td colspan="2">
																结果 : 
																<span class="lz2">
											...
											<tr>
												<td>
													<div style="margin: 10px 40px; float: right;">
														...
														<button id="submitok" type="button"  class="gl-btn2" onclick="prompt();" >完成</button>
