                ...
                <td>
                    <table class="datatable">
                        ...
                        <td style="width:10px;">&nbsp;</td>
                            <td style="width:10%">出库点编号</td>
                              <td width="1%" >|</td>
                            <td style="width:10%">出库时间</td>
                              <td width="1%" >|</td>
                            <td style="width:12%">总数量(tickts)</td>
                              <td width="1%" >|</td>
                            <td style="width:12%">总金额(riels)</td>
                              <td width="1%" >|</td>
        ...
        <c:forEach var="data" items="${pageDataList}" varStatus="status" >
            ...
            <td style="width:10px;">&nbsp;</td>
                ...
                <td style="width:*%">
                    ...
                    <span><a href="#" onclick="showBox('goodsIssues.do?method=getGoodsIssuesDetailBysgiNo&sgiNo=${data.sgiNo}&issueType=${data.issueType}','Details',650,1020)">详情</a></span>&nbsp;
