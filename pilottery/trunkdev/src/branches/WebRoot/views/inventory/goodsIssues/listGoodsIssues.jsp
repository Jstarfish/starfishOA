        ...
        <c:forEach var="data" items="${pageDataList}" varStatus="status" >
            ...
            <td style="width:10px;">&nbsp;</td>
                ...
                <td style="width:*%">
                    ...
                    <span><a href="#" onclick="showBox('goodsIssues.do?method=getGoodsIssuesDetailBysgiNo&sgiNo=${data.sgiNo}&issueType=${data.issueType}','Details',650,1020)">Details</a></span>&nbsp;
