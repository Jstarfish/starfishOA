...
<body>
<form method="post" action="goodsIssues.do?method=goodsIssuesForth"  id="goodIssuesParamt" name="goodIssuesParamt" >
...
<div id="container"> 
  ...
  <div id="main" >
   <div class="jdt">
      ...
      <div class="xd"><span class="zi">1.选择出库物品</span><span class="zi">2.扫描出库物品</span><span class="zi">3.完成出库</span><span class="zi">4.统计出库物品</span></div></div>
    <div class="bd">
          ...
          <td ><div class="tab" >
              <div class="tabn">
                <table  border="0"  cellpadding="0" cellspacing="0" width="100%" valign="top">
                  ...
                  <tr>
                    <td>
                    <div style="margin-bottom:20px;"><span class="dazit" style="font-size:18px;">出库单编号 :<span class="hz1">${goodIssuesParamt.doNo}</span></span></div>
                      ...
                      <div id="box" style="border:1px solid #ccc;">
                        ...
                        <tr>
                          <td style="padding-top:20px; " colspan="4" >备注 :
                            <textarea name="remarks" rows="5" class="edui-editor1" value="填写1 - 500字符,非强制性的" onfocus="if(this.value=='填写1 - 500字符,非强制性的'){this.value='';}"  onblur="if(this.value==''){this.value='填写1 - 500字符,非强制性的';}"></textarea></td>
                        </tr>
              ...
              <!--列表结束-->
                      ...
                      <button class="gl-btn2" type="button" onclick="showPage('goodsIssues.do?method=printOut&refNo=${goodIssuesParamt.doNo}','打印')">
                        ...
                        <button class="gl-btn2" type="button"  id="okbtn" onclick="onSubMit();">完成</button>
