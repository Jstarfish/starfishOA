          ...
          <td ><div class="tab" >
              <div class="tabn">
                <table  border="0"  cellpadding="0" cellspacing="0" width="100%" valign="top">
                  ...
                  <tr>
                    <td>
                    <div style="margin-bottom:20px;"><span class="dazit" style="font-size:18px;">Delivery Transfer :<span class="hz1">${goodIssuesParamt.doNo}</span></span></div>
              ...
              <!--列表结束-->
                      ...
                      <button class="gl-btn2" type="button" onclick="showPage('goodsIssues.do?method=printOut&refNo=${goodIssuesParamt.doNo}','Print')">
                        ...
                        <button class="gl-btn2" type="button"  id="okbtn" onclick="onSubMit();">Finish</button>
