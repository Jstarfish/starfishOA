...
<div id="printDiv">
  <table width="1000" border="0" cellspacing="0" cellpadding="0" align="center"  class="normal" style="margin:30px 20px 0px 60px;">
   <tr>
    ...
    <tr>
      <td colspan="3" style="font-size: 24px;line-height: 80px;border-bottom:2px solid #000;font-weight: bold;text-align:center;">批次入库</td>
    </tr>
    <tr height="80">
    ...
    <tr height="40">
      <td align="left"  colspan="3">收货单位: ${vo.sendOrg}</td>
    </tr>
    <tr>
      <td colspan="3" style="padding:20px 0;"><table width="1000" border="1" align="center" cellpadding="0" cellspacing="0"  class="normal">
          <tr align="center" height="80">
         
            <td width="139">方案编码</td>
            <td width="237">方案名称</td>
            <td width="180">批次编码</td>
            <td width="160">数量 (tickets)</td>
            <td width="100">面值</td>
            <td width="155">金额 (riels)</td>
          </tr>
          ...
          <tr align="left" height="80">
            <td colspan="3" style="padding:10px;">总数量(tickets):<fmt:formatNumber value='${vosum.tickets}' type='number' /></td>
