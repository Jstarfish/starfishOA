...
function prompt() {
	showDialog("submitInfo()","Confirm","您确定完成吗?");
}
...
<div id="container"> 
  ...
  <div id="main"> 
   <div class="jdt">
      ...
      <div class="xd"><span class="zi">1.选择货物</span><span class="zi">2.扫描货物</span><span class="zi">3.完成收货</span><span>4.汇总货物</span></div></div>
    <div class="bd">
                ...
                <table  border="0"  cellpadding="0" cellspacing="0" width="100%;" valign="top">
                  ...
                  <tr>
                    <td><div style="margin:10px 30px; float:right;">
                            ...
                            <button class="gl-btn2" type="button" id="okbton" onclick="prompt();">完成</button>
