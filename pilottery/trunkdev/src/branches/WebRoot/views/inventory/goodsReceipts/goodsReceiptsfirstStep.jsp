...
function doSubmit(){
	    ...
	    if($("#batchNo").val()=='' || $("#batchNo").val()==null){
	    	 showError("Batch can not be empty!"); 
			 return false;
	    }
                ...
                <table  border="0"  cellpadding="0" cellspacing="0" width="100%;" valign="top">
                  ...
                  <tr>
                    <td><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px; ">
                       ...
                       <button class="gl-btn2" type="button" onclick="javascript:doSubmit()"  style="display:block">Next</button>
                      </div></td>
                       </tr>
                      </table>
