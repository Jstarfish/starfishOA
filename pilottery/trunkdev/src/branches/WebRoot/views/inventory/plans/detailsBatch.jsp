			...
			<table class="datatable" id="table1_head" width="100%">
				<tbody>
					<tr class="headRow">
						...
						<td style="width: 5%">Plan</td>
						<td width="2%">|</td>
						<td style="width: 9%">Name Of Lottery</td>
						<td width="2%">|</td>
						<td style="width: 10%">Batch</td>
						<td width="2%">|</td>
						<td style="width: 13%">Number Of Group</td>
						<td width="2%">|</td>
						<td style="width: 15%">Tickets Per Group(tickets)</td>
						<td width="2%">|</td>
						<td style="width: 13%">Total Trunk</td>
						<td width="2%">|</td>
						<td style="width: 13%">Batch Total(tickets)</td>
						<td width="2%">|</td>
