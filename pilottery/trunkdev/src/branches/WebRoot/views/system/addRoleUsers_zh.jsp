...
<body>
						...
						<table>
							<tr>
								...
								<td class="f_left_td" style="height:50px" colspan="2" >
								 <font color=""style="front:14px/ 20px '微软雅黑', Arial, Helvetica, sans-serif">当前角色名称： ${role.name}</font>
								</td>
								<td class="f_left_td" style="width:50px"></td>
							</tr>
							<tr>
	...
	<div style="position: absolute;	bottom: 0px;left:0px;right: 0px;background-color: #f9fafc;	height: 60px;border-top:1px solid #eaedf1;">
		...
		<input id="okButton" type="button" onclick="saveRole()" value='提交' class="button-normal"></input></span> 
		<span style="float: right;margin-right: 50px;margin-top:15px;">			
		<input type="button" value="取消" onclick="doClose();" class="button-normal"></input></span>
	</div>
