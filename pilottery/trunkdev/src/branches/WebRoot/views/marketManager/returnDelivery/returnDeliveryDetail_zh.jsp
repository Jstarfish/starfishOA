        ...
        <div style="position:relative; z-index:1000px;">
          <table class="datatable" id="table1_head" width="100%">
            <tbody><tr>
              <th width="23%">方案 </th>
              <th width="2%">|</th>
              <th width="23%">还货数量 (本)</th>
              <th width="2%">|</th>
              <th width="23%">还货数量 (张)</th>
              <th width="2%">|</th>
              <th width="*%">还货金额 (瑞尔)</th>
            </tr>
          </tbody></table>
