...
public class GoodsReceiptsServiceImpl implements GoodsReceiptsService {
	...
	public void addGoodsBatch(GoodsStruct goodsStruct) {
		...
		try {
			...
			System.out.println("ib"+goodsStruct.getSgrNo());
			System.out.println("planCode"+goodsStruct.getPplan());
			System.out.println("batchNo"+goodsStruct.getPbatch());
			System.out.println("houseCode"+goodsStruct.getPwarehouse());
			System.out.println("popertype"+goodsStruct.getPopertype());
			System.out.println("poper"+goodsStruct.getPopertype());
	...
	private void addGoodsTransBatch(GoodsStruct goodsStruct) {
		...
		try {
			...
			System.out.println("goodsStruct.getCode(): " + goodsStruct.getCode());
			System.out.println("goodsStruct.getPwarehouse(): " + goodsStruct.getPwarehouse());
			System.out.println("goodsStruct.getPopertype(): " +goodsStruct.getPopertype());
