...
public class Teller extends AbstractEntity {
	...
	public String toString() {
		return "Teller [agencyCode=" + agencyCode + ", agencyCodeToChar=" + agencyCodeToChar + ", agencyParent=" + agencyParent + ", latestLogOffTime=" + latestLogOffTime + ", latestLogOnTime=" + latestLogOnTime + ", latestTerminalId=" + latestTerminalId + ", tellerCode=" + tellerCode
				+ ", tellerCodeToChar=" + tellerCodeToChar + ", tellerName=" + tellerName + ", tellerPassword=" + tellerPassword + ", tellerStatus=" + tellerStatus + ", tellerType=" + tellerType + "]";
	}
}
