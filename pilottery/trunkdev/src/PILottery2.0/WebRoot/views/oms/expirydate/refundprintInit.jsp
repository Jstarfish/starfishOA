...
<body>
<form:form modelAttribute="refundForm" action="refundquery.do?refunInfoPrint" method="post" id="refundForm" name="refundForm">
...
<div id="mainDiv">
   <div class="jdt" style="background: url(views/oms/game-draw/img/zxtpbj-3.png) no-repeat left top;">
    ...
    <div class="xd">
          		  	<span >1.Refund</span>
        <span>2.Refund Information</span>
        <span class="zi">3.Print Refund Information</span>
    </div>
    <div class="CPage">
