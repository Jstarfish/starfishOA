       ...
       <form:form modelAttribute="salegamepayinfoForm" action="expirydate.do?method=list">
            ...
            <div class="left">                      
                     ...
                     <span>Operator：<form:input path="payer" maxlength="20" class="text-normal"/></span>
                      <span>
                     Time:
                     Start<input id="startpayTime" name="startpayTime" value="${startpayTime }" class="Wdate" type="text" onFocus="WdatePicker({maxDate:'#F{$dp.$D(\'endpayTime\')}'})"/> 
						--
			   	 	End<input id="endpayTime" class="Wdate " value="${endpayTime}" name="endpayTime" type="text"  onFocus="WdatePicker({minDate:'#F{$dp.$D(\'startpayTime\')}'})"/>
                     </span>
