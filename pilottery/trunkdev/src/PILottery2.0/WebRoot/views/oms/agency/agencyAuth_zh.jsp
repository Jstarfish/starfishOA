						...
						<c:if test="${game.flag==0}">
							...
							<c:when test="${game.claimingScope == 0}">
								<select name="guth[${s.index}].claimingScope" class="select-s">				  					
				  					...
				  					<option value="3">销售站</option>
								</select>
							</c:when>							
							<c:when test="${game.claimingScope == 1}">
								<select name="guth[${s.index}].claimingScope" class="select-s">					  					
				  					<option value ="0" >中心</option>
				  					<option value="1" selected="selected">一级区域</option>
				  					<option value="2">二级区域</option>
				  					<option value="3">销售站</option>
								</select>
							</c:when>
							<c:when test="${game.claimingScope == 2}">
								<select name="guth[${s.index}].claimingScope" class="select-s">					  					
				  					<option value ="0" >中心</option>
				  					<option value="1">一级区域</option>
				  					<option value="2" selected="selected">二级区域</option>
				  					<option value="3">销售站</option>
								</select>
							</c:when>
							<c:when test="${game.claimingScope == 3}">
								<select name="guth[${s.index}].claimingScope" class="select-s">					  					
				  					...
				  					<option value="1">一级区域</option>
				  					<option value="2">二级区域</option>
				  					<option value="3" selected="selected">销售站</option>
								</select>
							</c:when>
							<c:otherwise>
								<select name="guth[${s.index}].claimingScope" class="select-s">					  					
