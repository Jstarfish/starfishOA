	...
	<div id="headDiv">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <table class="datatable">
                <tr class="headRow">
                   <td style="width:100px" class="nowrap">Terminal Code</td>
                   <td style="width:100px" class="nowrap">Machine</td>
                   <td style="width:100px" class="nowrap">Current Version</td>
                   <td style="width:140px" class="nowrap">Last Update Time</td>
                   <td style="width:140px" class="nowrap">Last Report Time</td>
