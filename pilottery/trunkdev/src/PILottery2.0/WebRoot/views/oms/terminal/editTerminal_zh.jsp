...
$(function(){
	...
	var mode = '${terminal.trainingMode.value}';
	$("#trainingmode").val(mode);
});
</script>
</head>
<body>
		...
		<div class="pop-body">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" >
				...
				<tr>
					...
					<td><span id="uniquecodeTip" class="tip_init">* 非空，数字或英文字符，长度不超过20!</span><input type="hidden" value="${terminal.terminalType}" id="terminalTypeHiden"/></td>
				</tr>
				<tr>
