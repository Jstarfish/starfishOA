...
<body>
<div id="title">Agency Notice</div>
<!--中间部分开始-->
<div style="position:absolute;top:39px;bottom:0px;width:100%;">
    <!--左侧列表开始-->
    <div id="left1">
        <div class="tit">Select region</div>
        <div>
            <ul id="treeDemo" class="ztree"></ul>
        </div>
        <div class="button-div" style="padding:10px" onclick="return tsmsg.addar();">Add to List</div>
        <div class="tit">Select agency：</div>
        <div>
            <textarea id="txtagencys" name="txtagencys" cols="30" rows="8" class="textarea1" onkeyup="this.value=this.value.replace(/[^\d;]/g,'')" placeholder="Please enter the agency code, separated by semicolon ';'"></textarea>
        </div>
    ...
    <div id="right1">
        ...
        <input name="title" id="txtmsgtitle" tabindex="1" type="text" class="input-text1" maxlength="300" placeholder="Maximum length 300 characters">
        <div><span id="txtmsgcontentTip"></span></div>
        <textarea id="txtmsgcontent" name="content" rows="10" class="textarea2" maxlength="2000" placeholder="Please enter the message content, maximum 3600 characters"></textarea>
