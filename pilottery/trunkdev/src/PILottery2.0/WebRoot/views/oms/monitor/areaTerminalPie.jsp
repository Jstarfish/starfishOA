...
<html>
<head>
<title><!--终端上线占比-->Terminal Online Percentage</title>
...
<script type="text/javascript" charset="UTF-8" > 
	...
	function drawGraph(dataList) {
		...
		$('#container').highcharts({
		       ...
		       title: {
		           text: '  Real-time Percentage of Online Terminals ' //当前全系统终端机上线占比
		       },
		       subtitle: {
                   text: getCurrentDate()
               },
		       ...
		       series: [{//设置每小个饼图的颜色、名称、百分比  
		           type: 'pie',  
		           name: '<br/><br/>Total:'+totalCount+' <br/>Percentage',  //终端机总数 //台<br/> 占比
		           data: [  
		               {name:'Offline',y:totalCount-onlineCount},  //未上线数量
		               {name: 'Online',sliced: true,selected: true,y:onlineCount} //上线数量
		           ]  
		       }]
		   });
	};
...
<body>
	<div id="title">Online Percentage</div>
