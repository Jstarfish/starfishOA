	    ...
	    <tr>
	        ...
	        <td width="*%">
	           <div id="div1" style="height:100%;">
	               <ul>
	                   <li>Total Sales Amount (Riels):<span id="issueSaleAmount">&nbsp;&nbsp;<fmt:formatNumber value="${gameIssue.issueSaleAmount+gameIssue.issueCancelAmount}" pattern="#,###"/></span></li>
	            ...
	            <div id="div2" style="height:100%;display:none">
					<ul>
	                   ...
	                   <li>Draw Numbers:<span id="winningResult">&nbsp;&nbsp;${gameIssue.winningResult}</span></li>
	               </ul>
	            ...
	            <div id="div3" style="height:100%;display:none">
					<table id="dataRows" class="datatable">
			            <tr class="headRow">
			                ...
			                <th width="1%">|</th>
			                <td style="width:15%" title="Agency Code">Agency Code</td>
			                <th width="1%">|</th>
			                <td style="width:15%" title="Agency Name">Agency Name</td>
			                <th width="1%">|</th>
			                <td style="width:15%" title="Agency Address">Agency Address</td>
			                <th width="1%">|</th>
			                <td style="width:*%" title="Winning Bets in Agency">Winning Bets in Agency</td>
			            </tr>
