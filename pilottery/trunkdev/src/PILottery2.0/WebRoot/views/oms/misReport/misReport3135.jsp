...
$(document).ready(function() { 
	var title = "Abandoned Award Statistics|"
...
<body style="overflow: hidden;">
	<div id="title"><!-- 体育彩票弃奖统计表 --> Abandoned Award Statistics</div>
			...
			<form:form id="form" modelAttribute="misReportForm" action="misReport.do?method=misReport3135&init=false">
				...
				<div style="overflow: right;">
	            	<span style="position: absolute;right: 80px;">
		        		<input type="hidden" id="reportTitle" name="reportTitle" value="Abandoned Award Statistics">
			...
			<table class="datatable" id="exportPdf">
			  <thead>
				<tr class="headRow">
					...
					<td width="15%"><!--期次-->Unit</td>	
					<td width="1%" noExp="true">|</td>
					<td width="15%"><!--高等奖弃奖注数-->High-Level Bets Abandoned</td>
					<td width="1%" noExp="true">|</td>
					<td width="15%"><!--高等奖弃奖金额-->High-Level Abandoned Award</td>
					<td width="1%" noExp="true">|</td>
					<td width="15%"><!--低等奖弃奖注数-->Low-Level Bets Abandoned</td>
					<td width="1%" noExp="true">|</td>
					<td width="15%"><!--低等奖弃奖金额-->Low-Level Abandoned Award</td>
					<td width="1%" noExp="true">|</td>
					<td width="*%"><!--弃奖合计-->Total Abandoned</td>
				</tr>
				</thead>
			</table>
