...
$(document).ready(function() { 
	var title = "NSL Lottery Payout Statistics (By Prize Level)|"
	...
	<div id="bodyDiv">
		<table class="datatable" id="exportPdfData">
			...
			<tr class="dataRow">
				...
				<td width="1%" noExp="true">&nbsp;</td>
				<td width="15%" style="text-align:right; padding-right: 4%;"><fmt:formatNumber value="${item.hdPayAmount}" type="number"/></td>
				<td width="1%" noExp="true">&nbsp;</td>
				<td width="15%" style="text-align:right; padding-right: 4%;"><fmt:formatNumber value="${item.hdPaySum}" type="number"/></td>
				<td width="1%" noExp="true">&nbsp;</td>
				<td width="15%" style="text-align:right; padding-right: 4%;"><fmt:formatNumber value="${item.ldPaySum}" type="number"/></td>
				<td width="1%" noExp="true">&nbsp;</td>
			...
			<tr class="dataRow" bgcolor="#F8F8FF">
				...
				<c:if test="${!empty resultSum}">
					...
					<td width="1%" noExp="true">&nbsp;</td>
					<td style="text-align:right; padding-right: 4%;"><fmt:formatNumber value="${resultSum.hdPayAmount}" type="number"/></td>
					<td width="1%" noExp="true">&nbsp;</td>
					<td style="text-align:right; padding-right: 4%;"><fmt:formatNumber value="${resultSum.hdPaySum}" type="number"/></td>
					<td width="1%" noExp="true">&nbsp;</td>
					<td style="text-align:right; padding-right: 4%;"><fmt:formatNumber value="${resultSum.ldPaySum}" type="number"/></td>
					<td width="1%" noExp="true">&nbsp;</td>
