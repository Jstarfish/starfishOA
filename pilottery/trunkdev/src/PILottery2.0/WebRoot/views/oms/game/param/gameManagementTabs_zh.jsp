			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td><div class="game">
									...
									<tr>
										...
										<div style="height:210px; overflow:auto;">
											<table width="100%" border="0" cellspacing="0"
												...
												<tr>
													<td>中奖缴税起征点：<fmt:formatNumber value="${gameManagementForm.gamePolicyParam.taxThreshold}" type="number"/> KHR
													</td>
												</tr>
												<tr>
									...
									<tr>
										...
										<div style="height:210px; overflow:auto;">
											<table width="100%" border="0" cellspacing="0"
												...
												<tr>
													<td>开奖模式：
															<c:if test="${gameManagementForm.normalRuleParameter.drawMode==1}">自动开奖</c:if>
							...
							<c:if test="${gameManagementForm.gameParameterHistory.gameCode==12}">
							<div class="bg">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td class="title4">
