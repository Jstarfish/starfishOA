...
SJZPrinter = function() {
	...
	function getPackInfo(tCode) {
		...
		{
			fpi.errCode = 1;
			fpi.errMessage ="Please input barcode！";
			return fpi;
		}
		...
		if(len == trunkLen || len == boxLen ||len ==ticketLen)
		{
			...
			fpi.errCode = 1;
			fpi.errMessage ="The barcode does not meet the specification！";
			return fpi;
		}
		...
		if(objRet != null)
		{
			...
			{
				objRet.errCode =1;
				objRet.errMessage ="The plan or the batch is not meet the define ！";
				return objRet;
			}
			...
			{
				objRet.errCode =1;
				objRet.errMessage ="The barcode already exists,please try another！";
				return objRet;
			}
			objRet.errCode =0;
	...
	function getPackInfoExt(tCode) {
		...
		{
			fpi.errCode = 1;
			fpi.errMessage ="The batch is invalid ！";
			return fpi;
		}
