...
<div id="container"> 
  ...
  <div id="main"> 
   <div class="jdt">
      ...
      <div class="xd-cn"><span class="zi">1.选择货物</span><span class="zi">2.扫描货物</span><span class="zi">3.完成收货</span><span class="zi">4.汇总货物</span></div></div>
          <div class="bd">
          ...
          <td ><div class="tab" >
              <div class="tabn">
                <table  border="0"  cellpadding="0" cellspacing="0" width="100%" valign="top">
                  ...
                  <tr>
                    <td><div class="nr">
                    <div style="margin-bottom:20px;"><span class="dazit" style="font-size:18px;">还货单编号:<span class="hz1">${goodReceiptParamt.returnNo}</span></span></div>
