...
<input  type="hidden" name="sgrNo"  id="sgrNo" value="${param.sgrNo}">
 ...
 <input type="hidden" name="operType" value="${param.operType}">
  ...
  <input type="hidden" name="returnNo" id="returnNo" value="${param.returnNo}">
          ...
          <td ><div class="tab" >
              <div class="tabn">
                <table  border="0"  cellpadding="0" cellspacing="0" width="100%" valign="top">
                  ...
                  <tr>
                    <td><div class="nr">
                    <div style="margin-bottom:20px;"><span class="dazit" style="font-size:18px;">Return Delivery Order:<span class="hz1">${param.returnNo}</span></span></div>
                      ...
                      <div class="nr">
                        <div class="title-mbx">Batch Return details </div>
