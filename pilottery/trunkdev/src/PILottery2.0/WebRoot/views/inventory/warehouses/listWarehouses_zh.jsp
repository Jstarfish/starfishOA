            ...
            <div class="right">
                <table width="260" border="0" cellspacing="0" cellpadding="0">
                    <tr style="height:50px;line-height:50px">
                        <td align="right">
                            <input type="button" value="新增仓库" onclick="showBox('warehouses.do?method=addWarehouseInit','新增仓库', 650, 800);" class="button-normal"></input>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <table class="datatable">
            <c:forEach var="row" items="${pageDataList}" varStatus="status">
                <tr class="dataRow">
                    ...
                    <td width="1%">&nbsp;</td>
                    <td style="width:*%">
                        <span><a href="#" onclick="showBox('warehouses.do?method=warehouseDetails&curWarehouseCode=${row.warehouseCode}','仓库详情', 650, 800);">详情</a></span>&nbsp;|
                        <span><a href="#" onclick="showBox('warehouses.do?method=modifyWarehouseInit&curWarehouseCode=${row.warehouseCode}','修改仓库信息', 650, 800);">修改</a></span>&nbsp;|
