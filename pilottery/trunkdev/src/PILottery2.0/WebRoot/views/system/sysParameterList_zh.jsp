		...
		<tr>
			<td>
				...
				<tr class="headRow">
					...
					<td style="width:15%" scope="col">系统参数编码</td>
					<th width="1%">|</th> 
					<td style="width:18%" scope="col">系统参数描述</td> 
					<th width="1%">|</th> 
					<td style="width:18%" scope="col">系统参数值</td> 
					<th width="1%">|</th> 
	 ...
	 <c:forEach var="u" items="${pageDataList}" varStatus="status" > 
		<tr class="dataRow">
			...
			<td style="width:*%" scope="col">
				...
				<a href="#" onclick="showBox('sysParameter.do?method=editSysParameter&id=${u.id}', '编辑',300,650);">编辑</a>
		   </td> 
		</tr>
	</c:forEach> 
	</table>
