            ...
            <div class="left">
             ...
             <div style="overflow: right;">
	        	<span style="position: absolute;right: 80px;">
	        		<input type="hidden" id="reportTitle" name="reportTitle" value="部门库存日结报表">
                ...
                <td>
                    <table class="datatable" id="exportPdf">
                        <tr class="headRow">
                            ...
                            <td style="width:9%">部门</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:9%">方案</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:9%">期初数量(张)</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:9%">入库数量(张)</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:9%">出库数量(张)</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:9%">销售数量(张)</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:9%">退货数量(张)</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:9%">损毁数量(张)</td>
                            <td width="1%" noExp="true">|</td>
