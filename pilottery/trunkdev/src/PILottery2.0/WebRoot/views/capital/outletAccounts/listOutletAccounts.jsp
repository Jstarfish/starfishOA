            		...
            		<select class="select-normal" name="orgCode" >
            		 	<c:if test="${sessionScope.current_user.id == 0}">
            		 		...
            		 		<c:forEach var="obj" items="${orgList}" varStatus="s">
	                   	   		<c:if test="${obj.orgCode != outletAcctForm.orgCode}">
        ...
        <table class="datatable">
         <c:forEach var="data" items="${pageDataList}" varStatus="status" >
            <tr class="dataRow">
                ...
                <td width="1%">&nbsp;</td>
                <td style="width:*%">
                    <span><a href="#" onclick="showBox('account.do?method=editOutletAccount&agencyCode=${data.agencyCode }','Edit',550,800);">Edit</a></span>
                    <%-- 
                    |
