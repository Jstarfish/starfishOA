                    ...
                    '<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%" style="word-wrap:break-word;">' +
                        ...
                        '<tr height="60px">' +
                            '<td colspan="2" class="fotter">' +
                                '<input id="ok_button" type="button" onclick="button_offcancle(),' + func + '" class="my-button" value="确定" style="float:left;margin-left:50px"></input>' +
...
function showError(errorMsg) {
    showMsg("信息提示",errorMsg,"error");
}

/**
 * 防止按钮重复点击
 * --------------------------------***/
function button_offcancle() {
	var btnObj = document.getElementById("ok_button");
