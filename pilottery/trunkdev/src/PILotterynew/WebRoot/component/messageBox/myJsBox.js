                    ...
                    '<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%" style="word-wrap:break-word;">' +
                        ...
                        '<tr height="60px">' +
                            '<td colspan="2" class="fotter">' +
                                '<input id="ok_button" type="button" onclick="' + func + '" class="my-button" value="OK" style="float:left;margin-left:50px"></input>' +
            ...
            '<div id="dialog" style="height:220px;width:350px">' +
                ...
                '<div class="container">' +
                    '<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%" style="word-wrap:break-word;">' +
                        ...
                        '<tr height="60px">' +
                            '<td colspan="2" class="fotter">' +
                                '<input type="button" id="jsOKButton" onclick="' + okFunc + ';closeMsg();" class="my-button" value="OK" style="float:right;margin-right:30px;"></input>' +
                            '</td>' +
                        '</tr>' +
                    '</table>' +
                '</div>' +
...
function showRight() {
    showMsg("Information","Congratulations, the </br>operation is successful!","right");
}
