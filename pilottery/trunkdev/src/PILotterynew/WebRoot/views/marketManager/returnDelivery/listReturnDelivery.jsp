...
function newReturnDelivery(){
	showBox('returnDelivery.do?method=initReturnDeliveryAdd','New Return Delivery',550,800);
}

function showDetails(stbNo){
	showBox('returnDelivery.do?method=returnDeliveryDetail&queryNo=' + stbNo,'Return Delivery Details',550,800);
}

function editOrder(stbNo){
	showBox('returnDelivery.do?method=initReturnDeliveryEdit&queryNo=' + stbNo,'Edit Return Delivery',550,800);
}

function approve(stbNo){
	showBox('returnDelivery.do?method=initAproveReturnDelivery&queryNo=' + stbNo,'Return Delivery Approve',550,800);
}
    ...
    <div class="queryDiv">
        <form action="returnDelivery.do?method=listReturnDeliveries" id="queryForm" method="post">
            <div class="left">
                ...
                <span>Date:
                    <input id="queryDate" name="queryDate" value="${form.queryDate}" class="Wdate text-normal" onfocus="WdatePicker({lang:'en',dateFmt:'yyyy-MM-dd',readOnly:true})"/>
                </span>
