...
$(document).ready(function(){
	...
	$("#okBtn").bind("click",function(){
		var result=true;
		  ...
		  if(!doCheck("cpName",checkNotnull($("#cpName").val()),"不能为空!")){
			  result = false;
		  }	 
...
function initBatchInfo(val){
	if(val!=''){
		...
		$("#batchNo").empty();
          ...
          $("#batchNo").append($("<option>").val('').text('--全部--')); 
	}
}
	...
	<form action="inventory.do?method=addCheckPoint"
		...
		<div class="pop-body">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td><span id="cpNameTip" class="tip_init">* 1~500 字符</span></td>

				</tr>

				<tr>
					<td width="25%" align="right">盘点人 :</td>
				...
				<tr>
					<td width="25%" align="right">生产批次 : </td>
		...
		<div class="pop-footer">
			<span class="left"><input id="okBtn" type="button"
				value="提交" class="button-normal"></input></span> <span class="right"><input
				type="button" value="取消" onclick="doClose();"
