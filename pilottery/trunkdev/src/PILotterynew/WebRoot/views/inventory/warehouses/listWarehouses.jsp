            ...
            <div class="right">
                <table width="260" border="0" cellspacing="0" cellpadding="0">
                    <tr style="height:50px;line-height:50px">
                        <td align="right">
                            <input type="button" value="New Warehouse" onclick="showBox('warehouses.do?method=addWarehouseInit','New Warehouse', 550, 800);" class="button-normal"></input>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <table class="datatable">
            <c:forEach var="row" items="${pageDataList}" varStatus="status">
                <tr class="dataRow">
                    ...
                    <td width="1%">&nbsp;</td>
                    <td style="width:*%">
                        <span><a href="#" onclick="showBox('warehouses.do?method=warehouseDetails&curWarehouseCode=${row.warehouseCode}','Warehouse Details', 550, 800);">Details</a></span>&nbsp;|
                        <span><a href="#" onclick="showBox('warehouses.do?method=modifyWarehouseInit&curWarehouseCode=${row.warehouseCode}','Edit Warehouse', 550, 800);">Edit</a></span>&nbsp;|
