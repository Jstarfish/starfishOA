...
<title>Batch Receipt Slip</title>
<style>
body {
...
<div id="printDiv">
  <table width="1000" border="0" cellspacing="0" cellpadding="0" align="center"  class="normal" style="margin:30px 20px 0px 60px;">
   <tr>
    ...
    <tr>
      <td colspan="3" style="font-size: 24px;line-height: 80px;border-bottom:2px solid #000;font-weight: bold;text-align:center;">Batch Receipt Slip</td>
    </tr>
    <tr height="80">
      <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td>Operator:${vo.sendOperater}</td>
            <td align="right"><fmt:formatDate  value="${vo.sendDate}"  pattern="yyyy-MM-dd HH:mm:ss" /></td>
          </tr>
        </table></td>
    </tr>
    <tr height="40">
      <td align="left"  colspan="3">Receiving Unit: ${vo.sendOrg}</td>
    </tr>
    <tr>
      <td colspan="3" style="padding:20px 0;"><table width="1000" border="1" align="center" cellpadding="0" cellspacing="0"  class="normal">
          <tr align="center" height="80">
         
            <td width="139">Plan Code</td>
            <td width="237">Plan Name</td>
            <td width="180">Batch</td>
            <td width="160">Quantity (tickets)</td>
            <td width="100">Face Value</td>
            <td width="155">Amount (riels)</td>
          </tr>
          ...
          <tr align="left" height="80">
            ...
            <td colspan="3" style="padding:10px;" >Total Amount (riels):<span style="float:right;"><fmt:formatNumber value='${vosum.amount}'  type='number'/></span></td>
