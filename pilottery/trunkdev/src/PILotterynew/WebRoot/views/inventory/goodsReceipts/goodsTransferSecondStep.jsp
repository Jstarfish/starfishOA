          ...
          <td ><div class="tab" >
              <div class="tabn">
                <table  border="0"  cellpadding="0" cellspacing="0" width="100%" valign="top">
                  ...
                  <tr>
                    <td><div class="nr">
                    <div style="margin-bottom:20px;"><span class="dazit" style="font-size:18px;">Stock Transfer :<span class="hz1">${param.stbNo}</span></span><c:if test="${sumtickts>0 }"><span class="dazit" style="font-size:18px;">Already in storage :<span class="hz1"><fmt:formatNumber value='${sumtickts}'  type='number'/> tickets</span></span></c:if></div>
                      ...
                      <div class="nr">
                        <div class="title-mbx">Transfer Incoming Details </div>
