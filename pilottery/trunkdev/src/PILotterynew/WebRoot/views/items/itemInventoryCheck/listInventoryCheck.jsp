    ...
    <div class="queryDiv">
        <form action="item.do?method=listInventoryCheck" method="POST" id="itemCheckQueryForm">
            <div class="left">
            	...
            	<span>Check Date: <input id="checkDateQuery" name="checkDate" value="${itemCheckQueryForm.checkDate}" class="Wdate text-normal" onfocus="WdatePicker({lang:'en',dateFmt:'yyyy-MM-dd',readOnly:true,isShowClear:true,isShowToday:true})" maxlength="40"/></span>
            	<span>Warehouse: 
