...
function newDeliveryOrder(){
	showBox('delivery.do?method=initDeliveryOrderAdd','New Delivery Order',550,800);
}
function editOrder(orderId){
	showBox('delivery.do?method=initDeliveryOrderEdit&deliveryOrderNo=' + orderId,'Edit Delivery Order',550,800);
}
