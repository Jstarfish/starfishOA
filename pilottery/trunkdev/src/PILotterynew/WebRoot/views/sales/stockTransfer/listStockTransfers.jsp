...
function newStockTransfer(){
	showBox('transfer.do?method=initStockTransferAdd','New Stock Transfer',550,800);
}
...
function editOrder(stbNo){
	showBox('transfer.do?method=initStockTransferEdit&stbNo=' + stbNo,'Edit Stock Transfer',550,800);
}
