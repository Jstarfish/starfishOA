            ...
            <div class="left">
             ...
             <div style="overflow: right;">
	        	<span style="position: absolute;right: 80px;">
	        		<input type="hidden" id="reportTitle" name="reportTitle" value="部门应缴款报表（美金）">
                ...
                <td>
                    <table class="datatable" id="exportPdf">
                        <tr class="headRow">
                            ...
                            <td width="1%" noExp="true">|</td>
                            <td style="width:15%">充值金额</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:15%">提现金额</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:15%">中心兑奖金额</td>
                            <td width="1%" noExp="true">|</td>
