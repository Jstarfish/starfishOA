...
public class ItemIssueServiceImpl implements ItemIssueService {
	...
	public void addItemIssue(NewItemIssueForm newItemIssueForm) throws Exception
	{
    	...
    	try {
			...
			stmt.setObject(5, newItemIssueForm.getRemark());
			...
			newItemIssueForm.setIssueCode(stmt.getString(6));
			newItemIssueForm.setC_errcode(stmt.getInt(7));
			newItemIssueForm.setC_errmsg(stmt.getString(8));
    	} catch (Exception e) {
    		throw e;
    	} finally {
