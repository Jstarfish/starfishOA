...
public class TransferRecordController {
	...
	public String listMMTransferRecords(HttpServletRequest request, ModelMap model,MMTransferRecordForm form) {
		...
		try{
			...
			if(currentUser.getIsCollector() == 1){
				//form.setCurrentUserId(currentUser.getId().intValue());
				form.setMarketManagerId(currentUser.getId().intValue());
			}
		...
		return LocaleUtil.getUserLocalePath("marketManager/MMTransRecords/listMMTransferRecords", request);
	}
	...
	public String salesDetail(HttpServletRequest request , ModelMap model) {
		...
		return LocaleUtil.getUserLocalePath("marketManager/MMTransRecords/salesDetail", request);
	}
	...
	public String payoutRecordDetail(HttpServletRequest request , ModelMap model) {
		...
		return LocaleUtil.getUserLocalePath("marketManager/MMTransRecords/payoutRecordDetail", request);
	}
	...
	public String returnRecordDetail(HttpServletRequest request , ModelMap model) {
		...
		return LocaleUtil.getUserLocalePath("marketManager/MMTransRecords/returnRecordDetail", request);
	}
}
