...
//        deviceProfiles.add(new DeviceProfile("Nexus S", 296, 491.33f,  4, 4,  48, 13, (hasAA ? 5 : 5), 48, R.xml.default_workspace_4x4));
//	@yyc 只添加需要的分辨率
        deviceProfiles.add(new DeviceProfile("Nexus S", 296, 491.33f,  3, 3,  72, 20, 3, 72, R.xml.default_workspace_3x3));
