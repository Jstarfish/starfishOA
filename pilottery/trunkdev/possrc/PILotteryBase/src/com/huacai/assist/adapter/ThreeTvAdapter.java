 ...
 * 
 */
public class ThreeTvAdapter extends BaseAdapter{
	/** 列表条目第一列*/
	...
	public ThreeTvAdapter(Context context,String[] string1,String[] string2,String[] string3,int id)
	{
	...
	public View getView(int arg0, View convertView, ViewGroup arg2) {
		...
		tv3.setText(string3[arg0]);//显示条目第三列
		return view;
	}
