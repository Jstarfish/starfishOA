...
public class CheckInventoryActivity1 extends BaseActivity {
...
//		sendInitialMsg();//发送查询出货单列表的请求数据
	...
	public void initData(){
		TwoTvAdapter adapter=new TwoTvAdapter(CheckInventoryActivity1.this, testStrAry1, testStrAry2,  R.layout.business_child_item2);//
