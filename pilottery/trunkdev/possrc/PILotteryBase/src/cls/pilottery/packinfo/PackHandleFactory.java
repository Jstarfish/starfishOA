...
public class PackHandleFactory {
	...
	public static PackInfo getPackInfo(String inputCode) throws Exception
	{
		...
		if(p == null)
			throw new Exception("Invalid Plan Code." +pCode);
	...
	public static PackUnitHandle createPackHandle(PlanInfo p) {
		...
		// modify by yyc date 2016-03-01 
//		int printer=Integer.parseInt(p.getPrinterCode());
		PackUnitHandle hander = new SJZPrinterHandler(p); // null;
//		if (printer == 1) {
...
//		}
	...
	public static PackUnitHandle createPackHandle(int printer, String planCode,
		...
		// modify by yyc 2016-03-01 
		PackUnitHandle hander = new SJZPrinterHandler(planCode, amountPerTicket,
				batchFirstTrunkCode, totalTicketNumOfGroup); // null;
//		if (printer == 1) {
