 ...
 *
 */
public class SelectInReturnStoreListActivity extends BaseActivity implements RequestListener, OnItemClickListener, OnSetItemListener, OnItemSelectedListener{
	private ListView lv;
	...
	public void initView() {
		super.initView();
		setMiddleText(R.string.string_return_in_store);//设置标题
