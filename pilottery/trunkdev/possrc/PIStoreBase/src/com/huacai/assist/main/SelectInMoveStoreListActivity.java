 ...
 *
 */
public class SelectInMoveStoreListActivity extends BaseActivity implements RequestListener, OnItemClickListener, OnSetItemListener, OnItemSelectedListener{
	private ListView lv;
	...
	public void initView() {
		super.initView();
		setMiddleText(R.string.string_move_in_store);//设置标题
