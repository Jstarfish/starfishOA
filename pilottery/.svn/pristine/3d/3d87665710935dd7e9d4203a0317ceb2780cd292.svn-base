...
function doSubmit(){
	...
	if (!doCheck("tellerCode",/^[0-9]\d{1,6}$/,hint2)) {
		result = false;
	} else {
		...
		<div class="pop-body">
		    <table width="100%" border="0" cellspacing="0" cellpadding="0" >
		    	...
		    	<tr>
					...
					<td align="center">
						<input class="text-big" name="tellerCode" id="tellerCode" value="${recomendId}" maxlength="6" onkeyup="this.value=this.value.replace(/[^\d,]/g,'')"/>
					</td>
				...
				<tr>
					<td align="right">Teller Status：</td>
					<td align="center">
