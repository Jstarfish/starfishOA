    ...
    <div id="bodyDiv">
        ...
        <c:forEach var="obj" items="${listreport}">
            <tr class="dataRow">
                ...
                <td style="width:12%">${obj.calcDate}</td>
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:12%">${obj.marketName }</td>
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:12%;text-align: right;"><fmt:formatNumber value="${obj.initialBalance }" /></td>
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:12%;text-align: right;"><fmt:formatNumber value="${obj.topUp }" /></td>
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:12%;text-align: right;"><fmt:formatNumber value="${obj.withdrawn }" /></td>
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:12%;text-align: right;"><fmt:formatNumber value="${obj.paid }" /></td>
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:12%;text-align: right;"><fmt:formatNumber value="${obj.finalBalance }" /></td>
                 <td width="1%" noExp="true">&nbsp;</td>
