...
<table style="margin:auto; width:95%;" border="1" id="exportPdf" cellspacing="0" cellpadding="0">
		<tr>
			<td colspan="4" align="center" style="font-size:24px; line-height:50px;">Kingdom of Cambodia National Sports Lottery Ltd. Agency Account Clearance Receipt</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="2">Agency Removing Operator：</td>
		</tr>
	</table>
</div>
</div>
