...
bool otl_set_issue_winning_stat(uint8 game_code, uint64 issue_num, WIN_TICKET_STAT *t)
{
    ...
    money_t p_total_winning_amount = t->winAmount;		// IN		NUMBER,	--总共中奖金额
    money_t p_total_winning_bet_count = t->winBet;	    // IN		NUMBER,	--总共中奖注数

    money_t p_high_winning_count = t->bigPrizeCnt;		// IN		NUMBER,	--高等奖中奖数量
    money_t p_high_winning_amount = t->bigPrizeAmount;	// IN		NUMBER,	--高等奖中奖金额
