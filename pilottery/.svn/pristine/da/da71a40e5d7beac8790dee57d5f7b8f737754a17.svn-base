...
var hint6 = 'Please enter the message content, maximum 42 Chinese characters';
$(function(){
...
<body>
<div id="title">Ticket Slogan</div>
<!--中间部分开始-->
<form:form modelAttribute="notice" id="planForm">
<div style="height:80%; width:100%;	">
<div id="right1" style="margin:0">
  <div class="tit1" style="padding:0;margin-top:20px; margin:0 auto; width:1200px;">Ticket Slogan<span id="txtmsgtitleTip"></span></div>
  ...
  <div style="margin:0 auto;width:1200px;">
	  <div class="button-div" style="float:left; width:68px;height:30px;line-height:30px" onclick="return tsmsg.clscc();">Clear</div>
	  <div id="button-div" class="button-div" style="float:right;width:68px;height:30px;line-height:30px" onclick="tsmsg.publisTicketInfo('Message successfully sent!','Failed to send the message!');">Send</div>
  </div>
<div></div>
</div>
</div>
