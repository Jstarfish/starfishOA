...
<body>
    <!-- 顶部标题块 -->
    <div id="title">Outlet Fund Report(USD)</div>
    
    <!-- 查询条件块 -->
    <div class="queryDiv">
        <form action="saleReport.do?method=outletFundReportUSD" id="queryForm" method="post">
            <div class="left">
            	<span>Outlet:
            		<input type="text" name="outletCode" value="${form.outletCode }" class="text-normal" ></input>
            	</span>
            	<span>Institution:
            		<select class="select-normal" name="cuserOrg" >
            			<option value="">--All--</option>
                   	   <c:forEach var="obj" items="${institutionList}" varStatus="plan">
                   	   		<c:if test="${obj.institutionCode == form.cuserOrg}">
             ...
             <div style="overflow: right;">
	        	<span style="position: absolute;right: 80px;">
	        		<input type="hidden" id="reportTitle" name="reportTitle" value="Outlet Fund Report(USD)">
                ...
                <td>
                    <table class="datatable" id="exportPdf">
                        <tr class="headRow">
                            ...
                            <td width="1%" noExp="true">|</td>
                            <td style="width:7%">Opening Balance</td>
                            <td width="1%" noExp="true">|</td>
                            ...
                            <td width="1%" noExp="true">|</td>
                            <td style="width:7%">Closing Balance</td>
                        </tr>
                    </table>
                 </td>
                 <!-- 表头和下方数据对齐 -->
