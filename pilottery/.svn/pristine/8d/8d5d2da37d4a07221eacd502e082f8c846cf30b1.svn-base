...
var hint = '* 选择机构和指定终端至少输入其中一项！';//选择区域或输入终端机编码
var hint2 = '* 选择机构和指定终端至少输入其中一项！';
				...
				<tr>
				  ...
				  <tr>
				    ...
				    <td align="center">
				     ...
				     <td><span id="termCodesTip" class="tip_init"> 10位数字，多个终端用(,)逗号分隔</span></td>
				  </tr>
				  <tr>
