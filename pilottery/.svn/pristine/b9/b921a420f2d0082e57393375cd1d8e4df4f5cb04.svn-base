                ...
                <table width="260" border="0" cellspacing="0" cellpadding="0">
                 <c:if test="${orgCode=='00'}">
                    <tr style="height:50px;line-height:50px">
                        <td align="right">
                            <input type="button" value="新增部门"  onclick="showBox('institutions.do?method=addInit','新增部门',550,700);" class="button-normal"></input>
                        </td>
                    </tr>
                    </c:if>
                </table>
         ...
         <c:forEach var="data" items="${pageDataList}" varStatus="status" >
            ...
            <td style="width:10px;">&nbsp;</td>
                ...
                <td style="width:*%">
                    ...
                    <c:if test="${orgCode=='00'}">
                    <span><a href="#" onclick="showBox('institutions.do?method=modyInit&orgCode=${data.orgCode }','修改',550,700);">修改</a></span>&nbsp;|
                    </c:if>
