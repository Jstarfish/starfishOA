...
<head>
    ...
    <script type="text/javascript" charset="UTF-8">
        jQuery(document).ready(function ($) {
            ...
            $("#secondScoreTeam").click(function () {
                document.getElementById("secondScoreTeamTip").innerHTML = "*";
                $("#secondScoreTeamTip").css("color", "#CDC9C9");
            });
        });
        ...
        function checkData() {
            ...
            var secondScoreTeam = $("#secondScoreTeam").val();
            ...
            if (secondScoreTeam == 0) {
                if (secondfhHomeScore > 0 ||
                        secondfhGuestScore > 0 ||
                        secondshHomeScore > 0 ||
                        secondshGuestScore > 0) {
                    document.getElementById("secondScoreTeamTip").innerHTML = '请选择进球队伍';
                    $("#secondScoreTeamTip").css("color", "red");
                    return false;
                }
            }
            if (secondScoreTeam > 0) {
                if (secondfhHomeScore == 0 &&
                        ...
                        secondshHomeScore == 0 &&
                        secondshGuestScore == 0) {
                    document.getElementById("secondScoreTeamTip").innerHTML = '请填写进球数';
                    $("#secondScoreTeamTip").css("color", "red");
                    return false;
                }
            }
            if (Number(secondfhHomeScore) > 0 && Number(secondfhGuestScore) == 0) {
                if (secondScoreTeam !=${fbsMatch.homeTeamCode}) {
                    document.getElementById("secondScoreTeamTip").innerHTML = '首先进球队伍与进球数不符';
                    $("#secondScoreTeamTip").css("color", "red");
                    return false;
                }
            }
            if (Number(secondfhHomeScore)  == 0 && Number(secondfhGuestScore)>0) {
                if (secondScoreTeam !=${fbsMatch.guestTeamCode}) {
                    document.getElementById("secondScoreTeamTip").innerHTML = '首先进球队伍与进球数不符';
                    $("#secondScoreTeamTip").css("color", "red");
                    return false;
                }
            }
            if (Number(secondfhHomeScore) + Number(secondshHomeScore) > 0 && Number(secondfhGuestScore) + Number(secondshGuestScore) == 0) {
                if (secondScoreTeam !=${fbsMatch.homeTeamCode}) {
                    document.getElementById("secondScoreTeamTip").innerHTML = '首先进球队伍与进球数不符';
                    $("#secondScoreTeamTip").css("color", "red");
                    return false;
            ...
            if (secondfhHomeScore == "" || secondfhHomeScore < 0|| secondfhHomeScore.match(reg) == null || Number(secondfhHomeScore)==99) {
                document.getElementById("secondfhHomeScoreTip").innerHTML = '数据不合法';
                $("#secondfhHomeScoreTip").css("color", "red");
                return false;
            }
            if (secondfhGuestScore == "" || secondfhGuestScore < 0|| secondfhGuestScore.match(reg) == null || Number(secondfhGuestScore)==99) {
                document.getElementById("secondfhGuestScoreTip").innerHTML = '数据不合法';
                $("#secondfhGuestScoreTip").css("color", "red");
                return false;
            }
            if (secondshHomeScore == "" || secondshHomeScore < 0|| secondshHomeScore.match(reg) == null || Number(secondshHomeScore)==99) {
                document.getElementById("secondshHomeScoreTip").innerHTML = '数据不合法';
                $("#secondshHomeScoreTip").css("color", "red");
                return false;
            }
            if (secondshGuestScore == "" || secondshGuestScore < 0|| secondshGuestScore.match(reg) == null || Number(secondshGuestScore)==99) {
                document.getElementById("secondshGuestScoreTip").innerHTML = '数据不合法';
                ...
                <td align="left" valign="middle">
                    <div class="tab" style="height:500px;">
                        <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" class="tabxian">
                            <tbody>
                            <tr>
                                <td class="tit"><span style="font-size: 24px;">2.等待再次录入开奖数据 </span></td>
                            </tr>
                            <tr>
                                <td>
                                        ...
                                        <table width="85%" border="0" align="center" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                ...
                                                <td height="30px" width="30px" align="left">
                                                    ...
                                                    <span id="secondScoreTeamTip" style="color:#CDC9C9;">*</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td height="30px" width="90px" class="xh">上半场主队进球数:</td>
                                                <td height="30px" width="10px" align="left">
                                            ...
                                            <tr>
                                                <td height="30px" width="90px" class="xh">下半场主队进球数:</td>
                                                <td height="30px" width="10px" align="left">
                                                    <input type="text" class="text-normal" value="0"
                                                           maxlength="2"
                                                ...
                                                <td height="30px" width="90px" class="xh">下半场客队进球数:</td>
                                                <td height="30px" width="30px" align="left">
                                                    <input type="text" class="text-normal" value="0"
                                                           maxlength="2"
                                                ...
                                                <td height="30px" width="20px"><input type="button"
                                                                                                  id="calculate"
                                                                                                  class="button-normal"
                                    ...
                                    <table border="0" width="85%" align="center" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td height="10px" align="center" colspan="4">
                                                <span id="resultTip" style="color:#CDC9C9"></span></td>
                                        </tr>
                                        <tr>
