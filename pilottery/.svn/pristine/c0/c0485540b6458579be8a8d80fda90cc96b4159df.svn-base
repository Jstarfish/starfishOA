...
$(document).ready(function() { 
	var title = "Lottery Payout Statistics (By Prize Level)|"
...
<body style="overflow: hidden;">
	<div id="title"><!-- 兑奖统计表(按奖等统计) -->Lottery Payout Statistics (By Prize Level)</div>
		<div id="queryDiv" class="queryDiv">
			<form:form id="form" modelAttribute="misReportForm" action="misReport.do?method=misReport3133&init=false">
				<div class="left">
					<span>
						<!-- 游戏名称 -->Game:
				...
				<div style="overflow: right;">
	            	<span style="position: absolute;right: 80px;">
		        		<input type="hidden" id="reportTitle" name="reportTitle" value="Lottery Payout Statistics (By Prize Level)">
		            	<!-- 
			...
			<table class="datatable" id="exportPdf">
			  <thead>
				<tr class="headRow">
					...
					<td width="1%" noExp="true">|</td>	
					<td width="15%"><!--高等奖兑奖注数-->High-Level Bets Paid</td>
					<td width="1%" noExp="true">|</td>
					<td width="15%"><!--高等奖兑奖金额-->High-Level Payout Amount</td>
					<td width="1%" noExp="true">|</td>
					<td width="15%"><!--低等奖兑奖金额-->Low-Level Payout Amount</td>
					<td width="1%" noExp="true">|</td>
	...
	<div id="bodyDiv">
		<table class="datatable" id="exportPdfData">
			...
			<tr class="dataRow">
				...
				<td width="1%" noExp="true">&nbsp;</td>
				<td width="15%" style="text-align:right;"><fmt:formatNumber value="${item.saleAmount}" type="number"/></td>
				<td width="1%" noExp="true">&nbsp;</td>
				<td width="15%"><fmt:formatNumber value="${item.hdPayAmount}" type="number"/></td>
				<td width="1%" noExp="true">&nbsp;</td>
				<td width="15%" style="text-align:right;"><fmt:formatNumber value="${item.hdPaySum}" type="number"/></td>
				<td width="1%" noExp="true">&nbsp;</td>
				<td width="15%" style="text-align:right;"><fmt:formatNumber value="${item.ldPaySum}" type="number"/></td>
				<td width="1%" noExp="true">&nbsp;</td>
				<td width="*%" style="text-align:right;"><fmt:formatNumber value="${item.paySum}" type="number"/></td>
			  </tr>
			  </c:forEach>
			  </c:if>
			<tr class="dataRow" bgcolor="#F8F8FF">
				...
				<c:if test="${!empty resultSum}">
					...
					<td width="1%" noExp="true">&nbsp;</td>
					<td ><fmt:formatNumber value="${resultSum.hdPayAmount}" type="number"/></td>
					<td width="1%" noExp="true">&nbsp;</td>
					<td style="text-align:right;"><fmt:formatNumber value="${resultSum.hdPaySum}" type="number"/></td>
					<td width="1%" noExp="true">&nbsp;</td>
					<td style="text-align:right;"><fmt:formatNumber value="${resultSum.ldPaySum}" type="number"/></td>
					<td width="1%" noExp="true">&nbsp;</td>
					<td style="text-align:right;"><fmt:formatNumber value="${resultSum.paySum}" type="number"/></td>
				</c:if>
			</tr>
		</table>
	</div>
