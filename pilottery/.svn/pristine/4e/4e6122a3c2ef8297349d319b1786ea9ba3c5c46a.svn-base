...
<body>
	<div id="title">机构管理</div>

	<div class="queryDiv">
		<form:form modelAttribute="omsAreaQueryForm" action="omsarea.do?method=listOMSArea" id="omsAreaQueryForm">
            <div class="left">                      
				<span>机构编码：<form:input id="areaCode" path="areaCode" value="${omsAreaQueryForm.areaCode}" class="text-normal" maxlength="10"/></span>
				<span>机构名称：<form:input id="areaName" path="areaName" value="${omsAreaQueryForm.areaName}" class="text-normal" maxlength="100"/></span>
