                ...
                <table width="260" border="0" cellspacing="0" cellpadding="0">
                 <c:if test="${orgCode=='00'}">
                    <tr style="height:50px;line-height:50px">
                        <td align="right">
                            <input type="button" value="New Institution"  onclick="showBox('institutions.do?method=addInit','New Institution',650,700);" class="button-normal"></input>
                        </td>
                    </tr>
                    </c:if>
                </table>
         ...
         <c:forEach var="data" items="${pageDataList}" varStatus="status" >
            ...
            <td style="width:10px;">&nbsp;</td>
                ...
                <td style="width:*%">
                    ...
                    <c:if test="${orgCode=='00'}">
                    <span><a href="#" onclick="showBox('institutions.do?method=modyInit&orgCode=${data.orgCode }','Edit Institution',650,700);">Edit</a></span>&nbsp;|
                    </c:if>
