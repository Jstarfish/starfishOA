...
$(document).ready(function(){	
	$("#dregeist").click(function(){	
		 $("#checkPointParmat").attr("action", "inventory.do?method=checkPointDamageReg");
													...
													<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top: 30px;">
														<tr>
															<td width="30%" style="border-bottom: 1px dashed #ccc; padding-bottom: 15px;" class="hoz">
																差异 :<span class="lz2">${result.cbeforeNum-result.cafterNum} </span>tickets
															</td>
															<td width="30%" style="border-bottom: 1px dashed #ccc; padding-bottom: 15px;">
																盘点前数量 : <span class="lz2"> ${result.cbeforeNum}</span>tickets
															</td>
															<td>
																盘点后数量 : <span class="lz2"> ${result.cafterNum}</span>tickets
															</td>
														</tr>
														<tr>
															<td>
																盘点差异 : <span class="lz2">${result.cbeforeNum-result.cafterNum}</span>tickets									
															</td>
															<td colspan="2">
																盘点结果 : 
																<span class="lz2">
														       ...
														       <div id="box" style="border:1px solid #ccc;">
														         <table id="fatable" class="datatable" cellpadding="0" cellspacing="0" width="100%">
														           <tbody>
														           	...
														           	<c:forEach var="item" items="${itemList}" varStatus="status" step="1">
																		...
																		<tr>
																			...
																			<td width="15%" align="right">																			
																				<input type="checkbox" id="recordId" name="recordId" value="${item.beforePkg}" align="left"></input>
																			</td>
														        	...
														        	<tr>
																		<td colspan="13" align="right"> 总共相差 ：${totaldiff} 本</td>
																	</tr>
																	</tbody>
														        </table>
														       </div>
																	...
																	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top: 10px;">
																		<tr>
													                       <td style="padding-top:20px; " colspan="4" >
														                       备注 :<textarea name="remark" rows="5" class="edui-editor1" value="Fill in the 1-500 character, non mandatory" onfocus="if(this.value=='Fill in the 1-500 character, non mandatory'){this.value='';}"  onblur="if(this.value==''){this.value='Fill in the 1-500 character, non mandatory';}"></textarea>
														                    </td>
													                    </tr>
																	</table>
																</div>
											...
											<tr>
												<td>
													<div style="margin: 10px 40px; float: right;">
														<c:if test="${result.cresult==2}">
															<button id="dregeist" type="button"  class="gl-btn2" disabled="disabled">损毁</button>
														</c:if>
														<button id="again" type="button"  class="gl-btn2">继续</button>
