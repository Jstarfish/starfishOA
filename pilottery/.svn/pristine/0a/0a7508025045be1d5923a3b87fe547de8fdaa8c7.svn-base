            ...
            <div class="right">
                <table width="260" border="0" cellspacing="0" cellpadding="0">
                    <tr style="height:50px;line-height:50px">
                        <td align="right">
                            <input type="button" value="New Inventory Check" onclick="showBox('item.do?method=addItemCheckInit','New Item Check',600,800);" class="button-normal"></input>
                        </td>
                    </tr>
                </table>
            </div>
