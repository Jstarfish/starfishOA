...
<script type="text/javascript"
	src="${basePath}/views/inventory/goodsReceipts/js/TransCodeHandler_zh.js"></script>
...
function prompt() {
	showDialog("submitInfo()","确认","您确认完成吗?");
}
											...
											<tr>
												<td>
													<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top: 30px;">
														...
														<tr>
															<td>
																盘盈或盘亏: <span class="lz2"><fmt:formatNumber value='${result.cbeforeNum-result.cafterNum}'  type='number'/></span>张									
															</td>
															<td colspan="2">
																盘点结果 : 
																<span class="lz2">
