			...
			<tr>
				<td class="nr">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:14px; color:#5e6d81; line-height:30px;">
						...
						<tr>
							<td>单注投注金额：
								<fmt:formatNumber type="number" value="${gameManagementForm.normalRuleParameter.singleBetAmount}" /> 瑞尔
							</td>
						</tr>
						<tr>
							<td>多期销售限制：
						...
						<tr>
							<td>单票最大销售限额：
								<fmt:formatNumber type="number" value="${gameManagementForm.normalRuleParameter.singleTicketMaxAmount}" /> 瑞尔
							</td>
						</tr>
						<tr>
							<td>弃奖去处：
