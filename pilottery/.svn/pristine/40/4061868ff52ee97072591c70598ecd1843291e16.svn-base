...
$(document).ready(function(){
   ...
   //SJZPrinter.initInfo(batchdetail.planCode,batchdetail.batchNo,batchdetail.ticketAmount,batchdetail.firstTrunkBath,batchdetail.ticketsEveryBatch,'1',batchdetail.ticketsEveryGroup);
			var 	jsonstr
			var doNo=$("#doNo").val();
		        var url='goodsIssues.do?method=getSaleDeliverOrderGameBystbNo&doNo='+doNo;
				$.ajax({
					url : url,
					dataType : "json",
					async : false,
	 ...
	 $("#okbtn").click(function(){  
		 ...
		 if(parseInt(rownum)>0){
			              switch_obj("okbtn","waitBtn");
						   $("#goodIssuesParamt").attr("action","goodsIssues.do?method=issueByDeliverySecondStep");
...
<input type="hidden" name="doNo" id="doNo" value="${param.doNo}">
 <input type="hidden" name="operType" id="operType" value="${param.operType}">
...
<div id="container"> 
  ...
  <div id="main" >
   <div class="jdt">
      ...
      <div class="xd"><span class="zi">1.选择出库物品</span><span class="zi">2.扫描出库物品</span><span >3.完成出库</span><span >4.统计出库物品</span></div></div>
    <div class="bd">
          ...
          <td ><div class="tab" >
              <div class="tabn">
                <table  border="0"  cellpadding="0" cellspacing="0" width="100%" valign="top">
                  ...
                  <tr>
                    <td><div class="nr">
                    <div style="margin-bottom:20px;"><span class="dazit" style="font-size:18px;">Delivery Order :<span class="hz1">${param.doNo}</span></span></div>
                      ...
                      </div>  <div id="planbox" style="border:1px solid #ccc;">
                      ...
                      <div class="nr">
                        <div class="title-mbx">出库信息列表</div>
                      </div>
              ...
              <!--列表结束-->
                      ...
                      <div style="margin-top:10px;  float:right; padding:0 20px;">
                       ...
                       <!--  <button class="gl-btn2" type="button" id="okbtn">Submit</button> -->
                        <input type="button" class="gl-btn2" id="okbtn" value="提交"/>
