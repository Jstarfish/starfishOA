...
public class SaleReportServiceImpl implements SaleReportService {
	...
	@Override
	public List<PlanModel> getSaleReportPlanList() {
		return saleReportDao.getSaleReportPlanList();
	}

	@Override
	public List<OutletFundVO> getOutletIntegratedList(SaleReportForm form) {
		return saleReportDao.getOutletIntegratedList(form);
	}

	@Override
	public OutletFundVO getOutletIntegratedSum(SaleReportForm form) {
		return saleReportDao.getOutletIntegratedSum(form);
	}

	@Override
	public List<InstitutionModel> getManageOrgsByUserId(int userId) {
		return saleReportDao.getManageOrgsByUserId(userId);
	}
