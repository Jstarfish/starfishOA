...
public class LogisticsForm implements Serializable {
	...
	public String toString() {
		return "LogisticsForm [batchCode=" + batchCode + ", logisticsCode=" + logisticsCode + ", packUnitCode=" + packUnitCode + ", planCode=" + planCode + ", queryType=" + queryType + ", specification=" + specification + ", tagCode=" + tagCode + ", ticketNo=" + ticketNo + "]";
	}
}
