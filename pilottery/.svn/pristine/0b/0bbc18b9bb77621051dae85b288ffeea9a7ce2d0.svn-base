			...
			<div id="main">
				<div class="jdt">
					<img src="views/inventory/goodsReceipts/images/jdt3_3.png" width="1000"
						height="30" />
					<div class="xd">
						<span></span><span class="zi">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.扫描安全码</span><span class="zi">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.中奖票信息</span><span class="zi">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.完善个人资料</span>
					</div>
				</div>
				<div class="bd">
												...
												<td>
													<table border="0" cellpadding="0" cellspacing="0" height="100%"
														...
														<tr>
															<td class="lz1">备注:</td>
															<td width="35%">
																<textarea id="remark" name="remark" class="text-big" cMaxByteLength="500" isCheckSpecialChar="true" style="height:50px;width:310px;"></textarea>
															</td>
