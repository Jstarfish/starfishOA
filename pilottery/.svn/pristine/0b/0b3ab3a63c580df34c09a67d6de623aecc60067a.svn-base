          ...
          <td ><div class="tab" >
              <div class="tabn">
                <table  border="0"  cellpadding="0" cellspacing="0" width="100%" valign="top">
                  ...
                  <tr>
                    <td><div class="nr">
                    <div style="margin-bottom:20px;"><span class="dazit" style="font-size:18px;">还货单号 :<span class="hz1">${returnNo}</span></span><span class="dazit" style="font-size:18px;">已入库 :<span class="hz1"><fmt:formatNumber value='${sumtickts}'  type='number'/>(Tickets)</span></span></div>
