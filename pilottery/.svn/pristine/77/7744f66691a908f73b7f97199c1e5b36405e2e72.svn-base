...
void Knuth::ran_array(long aa[],int n) {
    register int i,j;
...
void Knuth::ran_start(long seed) {
    register int t,j;
...
long Knuth::ran_arr_next() {
    return (*ran_arr_ptr>=0? *ran_arr_ptr++: ran_arr_cycle());
}

long Knuth::ran_arr_cycle() {
...
#if 0  // Start of rng.c IN VERBATIM
...
#endif  // end of rng.c IN VERBATIM
