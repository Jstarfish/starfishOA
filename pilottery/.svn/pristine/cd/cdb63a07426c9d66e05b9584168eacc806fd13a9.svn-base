	    ...
	    <tr>
	        ...
	        <td width="*%">
	           <div id="div1" style="height:100%;">
	               <ul>
	                   <li>销售金额(瑞尔) :<span id="issueSaleAmount">&nbsp;&nbsp;<fmt:formatNumber value="${gameIssue.issueSaleAmount+gameIssue.issueCancelAmount}" pattern="#,###"/></span></li>
	            ...
	            <div id="div2" style="height:100%;display:none">
					<ul>
	                   ...
	                   <li>录入人1 :<span id="firstDrawUser">&nbsp;&nbsp;${gameIssue.firstDrawUser}</span></li>
	                   <li>录入人2 :<span id="secondDrawUser">&nbsp;&nbsp;${gameIssue.secondDrawUser}</span></li>
	                   <li>期末奖池余额(瑞尔) :<span id="poolCloseAmount">&nbsp;&nbsp;<fmt:formatNumber value="${gameIssue.poolCloseAmount}" pattern="#,###"/></span></li>
	                   <li>开奖号码 :<span id="winningResult">&nbsp;&nbsp;${gameIssue.winningResult}</span></li>
	               </ul>
