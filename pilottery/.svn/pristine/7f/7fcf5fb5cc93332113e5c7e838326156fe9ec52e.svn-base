                ...
                <td>
                    <table class="datatable" id="exportPdf">
                        <tr class="headRow">
                            ...
                            <td width="1%" noExp="true">|</td>
                            <td style="width:7%" title="退票金额">退票金额</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:7%">退票佣金</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:7%">中心兑奖</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:7%">中心兑奖佣金</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:7%">中心退票</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:*%">中心退票佣金</td>
                        </tr>
                    </table>
                 </td>
                 <!-- 表头和下方数据对齐 -->
    ...
    <div id="bodyDiv">
        ...
        <c:if test="${fn:length(list) > 0}">
        	<tr class="dataRow">
                ...
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:*%;text-align: right;"><fmt:formatNumber value="${sum.centerCancelComm }" /></td>   
            </tr>
        </c:if>
        <c:forEach var="obj" items="${list}" varStatus="status" >
            <tr class="dataRow">
                ...
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:*%;text-align: right;"><fmt:formatNumber value="${obj.centerCancelComm }" /></td> 
            </tr>
          </c:forEach>
        </table>
    </div>
