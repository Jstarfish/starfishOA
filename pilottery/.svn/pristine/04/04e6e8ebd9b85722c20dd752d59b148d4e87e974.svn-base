...
<div id="gameParameter2">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<td class="nr" style="height:200px">
			...
			<tr>
				<td>单票销售金额告警阈值：<input type="text" name="gameParameterDynamic.auditSingleTicketSale" value="${gameParameter.auditSingleTicketSale}" style="width: 80px;" onblur="value=value.replace(/[^0-9]/g,'')" maxLength=9/> KHR</td>
			</tr>
			<tr>
				<td>单票兑奖金额告警阈值：<input type="text" name="gameParameterDynamic.auditSingleTicketPay" value="${gameParameter.auditSingleTicketPay}" style="width: 80px;" onblur="value=value.replace(/[^0-9]/g,'')" maxLength=9/> KHR</td>
			</tr>
			<tr>
				<td>单票退票金额告警阈值：<input type="text" name="gameParameterDynamic.auditSingleTicketCancel" value="${gameParameter.auditSingleTicketCancel}" style="width: 80px;" onblur="value=value.replace(/[^0-9]/g,'')" maxLength=9/> KHR</td>
			</tr>
		    </table>
		</td>
	   </tr>
