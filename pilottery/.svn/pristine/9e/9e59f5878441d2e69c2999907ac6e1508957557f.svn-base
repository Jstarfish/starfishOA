...
<div id="container"> 
  ...
  <div class="jdt">
      ...
      <div class="xd"><span class="zi">1.选择出库物品</span><span >2.扫描出库物品</span><span>3.完成出库</span><span >4.统计出库物品</span></div></div>
    <div class="bd">
                ...
                <table  border="0"  cellpadding="0" cellspacing="0" width="100%;" valign="top">
                      ...
                      <div  style="border:1px solid #ccc;">
                         <table  class="datatable"  id="table1_head" width="100%" >
                          <tr >
                            ...
                            <th width="1">|</th>
                            <th width="20%"  align="left">数量(tickets)</th>
                            <th width="1">|</th>
                            <th width="20%"  align="left">金额(riels)</th>
                  ...
                  <tr>
                       ...
                       <div style="margin:10px 20px; float:right;">
                                                                           总金额 :<span class="lz2" id="labsum"></span>riels
                      </div></td>
                       </tr>
                  <tr>
                       <td colspan="4"> 
