...
<div id="right2">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <td><div style="height:80px;margin-top:20px;margin-left:2%;margin-right:6%;background:lightgray;" >
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="height:70px;">
                    ...
                    <c:if test="${gameManagementForm.gameIssue.issueNumber == null}">
 					<tr>
                       <td rowspan="3" width="30%"><h3 style="margin-top:20px;">&nbsp;&nbsp;&nbsp;&nbsp;No current issue</h3></td>
                    </tr>
					</c:if>
            		<c:if test="${gameManagementForm.gameIssue.issueNumber != null}">
                    <tr>
                       ...
                       <td>Issue Start Time：<fmt:formatDate value="${gameManagementForm.gameIssue.realStartTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                    ...
                    <tr>
                       <td>Issue End Time：
                   	   ...
                   	   <td>Pool Amount：${gameManagementForm.gamePool.poolAmountAfter}</td>
                    </tr>
                    </c:if>
                </table>
            </div></td>
  				...
  				<tr>
				    <td class="nr" style="height:200px">
					    <table width="100%" border="0" cellspacing="0"
					      ...
					      <tr>
					        <td>Sale：&nbsp; &nbsp; &nbsp; 
					            <img id="isSaleBtn" src="${basePath}/img/on_en.png" style="vertical-align: middle;" onclick="return doChange('isSaleBtn', 'isSaleFlg') "/> 
                                <form:hidden path="gameParameterDynamic.isSale" id="isSaleFlg" />
					        </td>
					      </tr>
					      <tr>
					        <td>Payout： 
					        	<img id="isPayBtn" src="${basePath}/img/on_en.png" style="vertical-align: middle;" onclick="return doChange('isPayBtn', 'isPayFlg') "/> 
                            	<form:hidden path="gameParameterDynamic.isPay" id="isPayFlg"/>
					        </td>
					      </tr>
					      <tr>
					        <td>Refund：
					        	<img id="isCancelBtn" src="${basePath}/img/on_en.png" style="vertical-align: middle;" onclick="return doChange('isCancelBtn', 'isCancelFlg') "/> 
                ...
                <tr>
                    <td class="nr" style="height:200px">
                        <table width="100%" border="0" cellspacing="0"
                                                cellpadding="0" style="font-size:14px; color:#5e6d81; line-height:30px;">
                          <tr>
                            <td>Service Period 1：${gameManagementForm.gameParameterDynamic.serviceTime1}</td>
                          </tr>
                          <tr>
                            <td>Service Period 2：${gameManagementForm.gameParameterDynamic.serviceTime2}</td>
                          </tr>
                        </table>
                     </td>
                 </tr>
		...
		<c:if test="${gameManagementForm.gameParameterDynamic.gameCode==12 || gameManagementForm.gameParameterDynamic.gameCode==11 || gameManagementForm.gameParameterDynamic.gameCode==5 || gameManagementForm.gameParameterDynamic.gameCode==13}">
                  ...
                  <tr>
                    	<td class="nr" style="height:200px;">
	                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:14px; color:#5e6d81; line-height:30px;">
	                          <tr>
	                            <td>Auto-Draw Enabled：
	                            		<img id="isAutoDrawBtn" src="${basePath}/img/on_en.png" style="vertical-align: middle;" onclick="return doChange('isAutoDrawBtn', 'isAutoDrawFlg') "/> 
