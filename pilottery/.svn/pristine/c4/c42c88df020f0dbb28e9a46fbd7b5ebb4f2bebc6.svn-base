    ...
    <div class="queryDiv">
        <form action="item.do?method=listInventoryCheck" method="POST" id="itemCheckQueryForm">
            <div class="left">
            	...
            	<span>盘点日期: <input id="checkDateQuery" name="checkDate" value="${itemCheckQueryForm.checkDate}" class="Wdate text-normal" onfocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd',readOnly:true,isShowClear:true,isShowToday:true})" maxlength="40"/></span>
            	<span>盘点仓库: 
