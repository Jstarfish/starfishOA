...
<head>
    ...
    <script type="text/javascript" charset="UTF-8">
        ...
        function checkFormData() {
            ...
            if (end == "") {
                document.getElementById("endTip").innerHTML = "Please Enter Match End Sale Time!";
