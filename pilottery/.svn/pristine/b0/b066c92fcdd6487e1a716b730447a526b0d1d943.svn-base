...
comment on column INF_AGENCY_DELETE.TEMP_CREDIT is '临时信用额度';
comment on column INF_AGENCY_DELETE.MARGINAL_CREDIT is '永久信用额度';
...
comment on column GAME_PLANS.PUBLISHER_CODE is '印制厂商';
...
comment on column SYS_OPER_LOG.OPER_NO is '操作日志编号（RZ 12345678）';
comment on column SYS_OPER_LOG.OPER_PRIVILEGE is '功能模块代码（菜单名称）';
comment on column SYS_OPER_LOG.OPER_ADMIN is '操作人';
comment on column SYS_OPER_LOG.OPER_TIME is '操作时间';
comment on column SYS_OPER_LOG.OPER_MODE is '操作类型（1=新增；2=删除；3=更改）';
comment on column SYS_OPER_LOG.OPER_CONTENTS is '操作内容';
...
comment on column FUND_TUNING.TUNING_TYPE is '调整类型（1-调增，2-调减）';
...
comment on table HIS_ORG_FUND_REPORT is '机构资所辖销售站金历史报表';
...
comment on column HIS_PAY_LEVEL.LEVEL_9 is '九等奖奖金';
comment on column HIS_PAY_LEVEL.LEVEL_10 is '十等奖奖金';
