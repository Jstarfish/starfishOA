package cls.pilottery.web.goodsIssues.dao;
...
public interface GoodsIssuesDao {
	/**
	 * 
	 ...
	 * @throws
	 */
	public List<GoodsIssuesVo> getGoodsIssuesById(String sgiNO);
	 ...
	 * @param @param sgiNo
	 * @param @return 参数
	 * @return List<GoodsIssuesStockVo> 返回类型
	 * @throws
	 */
	public List<GoodsIssuesStockVo> getGoodsIssuesStockInfoByCode(String sgiNo);
	 ...
	 * @throws
	 */
	public List<GoodsIssuesVo> getGoodsIssuesByCode(String sgiNo);
