...
<body>
    <!-- 顶部标题块 -->
    <div id="title">Institution Outlets Statistics</div>
    
   
    <!-- 查询条件块 -->
    <div class="queryDiv">
        <form action="saleReport.do?method=institutionFundReport" id="queryForm" method="post">
            <div class="left">
            	<span>Institution:
                ...
                <td>
                    <table class="datatable" id="exportPdf">
                        <tr class="headRow">
                            ...
                            <td width="1%" noExp="true">|</td>
                            <td style="width:6%">Begin Arrears</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:5%">Top Up</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:5%">Withdraw</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:6%">Sales Amount</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:6%">Sales Comm</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:6%" title="Payout Amount">Payout Amount</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:6%">Payout Comm</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:6%" title="Return Amount">Return Amount</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:5%">Return Comm</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:6%">End Arrears</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:6%">Center Payout</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:6%">Center Comm</td>
                            <td width="1%" noExp="true">|</td>
    ...
    <div id="bodyDiv">
        ...
        <c:forEach var="obj" items="${list}" varStatus="status" >
            <tr class="dataRow">
                ...
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:6%;text-align: right;"><fmt:formatNumber value="${obj.finalBalance }" /></td>
                <td width="1%" noExp="true">&nbsp;</td>
