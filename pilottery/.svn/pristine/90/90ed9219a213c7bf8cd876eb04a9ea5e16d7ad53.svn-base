 ...
 *
 */
public class SelectCheckInventoryListActivity extends BaseActivity implements RequestListener, OnItemClickListener, OnSetItemListener, OnItemSelectedListener{
	private ListView lv;
