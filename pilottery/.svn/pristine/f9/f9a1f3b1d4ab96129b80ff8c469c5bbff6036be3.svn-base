...
function prompt() {
	showDialog("submitInfo()","Confirm","你确定你已经完成了吗？");
}
...
<div id="container"> 
  ...
  <div id="main">
    <div class="jdt"> <img src="views/inventory/goodsReceipts/images/jdt4_3.png" width="1000" height="30" />
      <div class="xd"><span class="zi">1.选择出库物品</span><span class="zi">2.扫描出库物品</span><span class="zi">3.完成出库</span><span>4.统计出库物品</span></div>
    </div>
    <div class="bd">
                ...
                <table  border="0"  cellpadding="0" cellspacing="0" width="100%;" valign="top">
                  <tr>
                    <td style="border-bottom:1px solid #ccc;  padding-bottom:10px;"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px; ">
                        <tr>
                          <td>出货单编号 : <span class="lz2"> ${goodIssuesParamt.doNo }</span></td>
                        </tr>
                      </table></td>
                  </tr>
                  <tr>
