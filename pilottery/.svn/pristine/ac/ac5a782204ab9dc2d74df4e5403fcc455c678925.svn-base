...
<head>
    ...
    <script src="${basePath}/views/report/js/issueSysReport.js"></script>
...
<div class="row base-margin" id="query">
    <ol class="breadcrumb">
        <li><strong><span style="color: #27a0d7">System Issue Report</span></strong></li>
    </ol>
		<form class="form-inline" role="form"
			style="float: left; width: 100%; margin-bottom: 0;" method="post"
			id="queryForm">
