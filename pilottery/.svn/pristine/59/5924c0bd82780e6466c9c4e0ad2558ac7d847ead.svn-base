...
public interface GameManagementDao {
	...
	public void updateControlParameter_S(GameParameterControlView param);
	public void updateControlParameter_D(GameParameterControlView param);
	...
	public Integer checkIssueExist(Short gameCode);
	
	public GameParameterHistory getGameParameterHistoryByNum(Map<String, Object> map);
	public GameIssue getFbsCurrentIssue(GameIssue gameIssue);
}
