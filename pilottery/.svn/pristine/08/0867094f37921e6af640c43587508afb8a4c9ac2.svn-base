    ...
    <div class="queryDiv">
        <form action="item.do?method=listDamagedItems" method="POST" id="itemDamageQueryForm">
            <div class="left">
	   			...
	   			<span>登记日期: <input id="damageDateQuery" name="damageDate" value="${itemDamageQueryForm.damageDate}" class="Wdate text-normal" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true,isShowClear:true,isShowToday:true})" maxlength="40"/></span>
