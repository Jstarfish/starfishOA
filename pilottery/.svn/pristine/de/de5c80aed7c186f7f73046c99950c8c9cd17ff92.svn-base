...
<div id="tabbox">
    <ul class="tabs" id="tabs">
        <li><a href="#" tab="tab1">Winner</a></li>
        <li><a href="#" tab="tab2">Handicap</a></li>
        <li><a href="#" tab="tab3">Totals Goal</a></li>
        <li><a href="#" tab="tab4">Score</a></li>
        <li><a href="#" tab="tab5">HF Time Pool</a></li>
        <li><a href="#" tab="tab6">OUOD</a></li>
    </ul>
    <ul class="tab_conbox">
        <li id="tab1" class="tab_con">
            ...
            <table width="50%" class="ms">
                <tr>
                    <td align="left">Total betting amount：<span class="cl-r">$${jsonWIN.sa+jsonWIN.ma}</span></td>
                    <td align="left">Single betting amount：<span class="cl-r">$${jsonWIN.sa}</span></td>
                    <td align="left">Multiple betting amount：<span class="cl-r">$${jsonWIN.ma}</span></td>
                </tr>
            </table>
            ...
            <table class="table table-striped table-bordered table-advance table-hover">
                ...
                <tr>
                    <th class="cl-h">#</th>
                    <th>Result</th>
                    <th class="hidden-phone">Total betting amount</th>
                    <th>Single betting amount</th>
                    <th>Multiple betting amount</th>
                    <th>Reference SP Value</th>
                    <th>Popularity</th>
                </tr>
                </thead>
                <tbody>
        ...
        <li id="tab2" class="tab_con">
            <div class="ms">
                <table width="50%">
                    <tr>
                        <td align="left">Total betting amount：<span class="cl-r">$${jsonHCP.sa+jsonHCP.ma}</span></td>
                        <td align="left">Single betting amount：<span class="cl-r">$${jsonHCP.sa}</span></td>
                        <td align="left">Multiple betting amount：<span class="cl-r">$${jsonHCP.ma}</span></td>
                    </tr>
                </table>
            </div>
            <table class="table table-striped table-bordered table-advance table-hover">
        ...
        <li id="tab3" class="tab_con">
            <div class="ms">
                <table width="50%">
                    <tr>
                        <td align="left">Total betting amount：<span class="cl-r">$${jsonTOT.sa+jsonTOT.ma}</span></td>
                        <td align="left">Single betting amount：<span class="cl-r">$${jsonTOT.sa}</span></td>
                        <td align="left">Multiple betting amount：<span class="cl-r">$${jsonTOT.ma}</span></td>
                    </tr>
                </table>
            </div>
            <table class="table table-striped table-bordered table-advance table-hover">
        ...
        <li id="tab4" class="tab_con">
            <div class="ms">
                <table width="50%">
                    <tr>
                        <td align="left">Total betting amount：<span class="cl-r">$${jsonSCR.sa+jsonSCR.ma}</span></td>
                        <td align="left">Single betting amount：<span class="cl-r">$${jsonSCR.sa}</span></td>
                        <td align="left">Multiple betting amount：<span class="cl-r">$${jsonSCR.ma}</span></td>
                    </tr>
                </table>
            </div>
            <table class="table table-striped table-bordered table-advance table-hover">
        ...
        <li id="tab5" class="tab_con">
            <div class="ms">
                <table width="50%">
                    <tr>
                        <td align="left">Total betting amount：<span class="cl-r">$${jsonHFT.sa+jsonHFT.ma}</span></td>
                        <td align="left">Single betting amount：<span class="cl-r">$${jsonHFT.sa}</span></td>
                        <td align="left">Multiple betting amount：<span class="cl-r">$${jsonHFT.ma}</span></td>
                    </tr>
                </table>
            </div>
            <table class="table table-striped table-bordered table-advance table-hover">
        ...
        <li id="tab6" class="tab_con">
            <div class="ms">
                <table width="50%">
                    <tr>
                        <td align="left">Total betting amount：<span class="cl-r">$${jsonOUOD.sa+jsonOUOD.ma}</span></td>
                        <td align="left">Single betting amount：<span class="cl-r">$${jsonOUOD.sa}</span></td>
                        <td align="left">Multiple betting amount：<span class="cl-r">$${jsonOUOD.ma}</span></td>
                    </tr>
                </table>
            </div>
            <table class="table table-striped table-bordered table-advance table-hover">
                ...
                <c:forEach items="${jsonOUOD.list}" var="dlist">
                    <tr>
                        <td class="cl-h">1</td>
                        <td>
                            <c:if test="${dlist.ret==1}">Over Odd</c:if>
                            <c:if test="${dlist.ret==2}">Over Even</c:if>
                            <c:if test="${dlist.ret==3}">Under Odd</c:if>
                            <c:if test="${dlist.ret==4}">Under Even</c:if>
                        </td>
