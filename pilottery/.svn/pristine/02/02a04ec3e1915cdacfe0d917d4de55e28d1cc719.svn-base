...
public class GameManagementServiceImpl implements GameManagementService {
	...
	@Override
	public GameParameterHistory getGameParameterHistoryByNum(Short gameCode, Long issueNumber) {
		Map<String,Object> map = new HashMap<String, Object>();
		map.put("gameCode", gameCode);
		map.put("issueNumber", issueNumber);
		return gameManagementDao.getGameParameterHistoryByNum(map);
	}

	@Override
	public GameIssue getFbsCurrentIssue(GameIssue gameIssue) {
		return gameManagementDao.getFbsCurrentIssue(gameIssue);
	}
}
