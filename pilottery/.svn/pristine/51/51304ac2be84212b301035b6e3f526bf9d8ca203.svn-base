...
<div id="gameParameter3">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<td class="title2">
			...
			<tr>
			    <td width="51%">服务时段</td>
			    <td width="37%" align="right"><a href="#" onclick="cancelEditGameParameter(${gameParameter.gameCode},3);" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image7','','${basePath}/img/cz-hover.png',1)"><img src="${basePath}/img/cz.png" width="32" height="42" id="Image7" title="取消编辑"/></a></td>
			    <td width="2%" align="right">|</td>
			    <td width="10%" align="right"><a href="#" onclick="prompt(3);" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image8','','${basePath}/img/save-hover.png',1)"><img src="${basePath}/img/save.png" width="32" height="42" id="Image8" title="保存"/></a></td>
			</tr>
		    </table>
		</td>
	    </tr>
