 ...
 *
 */
public class SelectInBatchStoreListActivity extends BaseActivity implements RequestListener, OnItemClickListener, OnSetItemListener, OnItemSelectedListener{
	private ListView lv;
	...
	public void initView() {
		super.initView();
		setMiddleText(R.string.string_batch_in_store);//设置标题
