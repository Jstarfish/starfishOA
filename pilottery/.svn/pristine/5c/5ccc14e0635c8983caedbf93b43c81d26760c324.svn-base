...
<script src="${basePath}/views/capital/js/adjustment.js"></script>
</head>
<body>
	<div class="row base-margin" id="query">
		<ol class="breadcrumb">
			<li><strong><span style="color: #27a0d7">Adjustment Record</span></strong></li>
		</ol>
		<form class="form-inline" role="form" style="float: left; width: 100%;margin-bottom:0;" method="post" id="queryForm">
			...
			<div class="form-group btn-right">
				<button type="button" class="btn btn-primary" id="adjustment" onclick="toAdjustment();">Adjust</button>
			</div>
		</form>
	</div>
