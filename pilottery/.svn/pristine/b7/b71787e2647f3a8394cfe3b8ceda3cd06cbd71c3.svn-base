...
//	@yyc 过滤 app
                final HashMap<String, String> showApps = new HashMap<String, String>();
                showApps.put("com.uc.browser.en", "");
                showApps.put("com.huacai.assist", "");
                showApps.put("com.huacai.pistore", "");
                showApps.put("com.huacai.rev0", "");
                showApps.put("com.huacai.rev1", "");
                showApps.put("com.huacai.rev2", "");
                showApps.put("com.huacai.rev3", "");
                showApps.put("com.android.camera", "");
                showApps.put("com.android.deskclock", "");
                showApps.put("com.android.calendar", "");
                showApps.put("com.android.gallery3d", "");
                showApps.put("com.android.settings", "");
                showApps.put("com.android.calculator2", "");
                // Create the ApplicationInfos
                for (int i = 0; i < apps.size(); i++) {
                    LauncherActivityInfoCompat app = apps.get(i);
                    // This builds the icon bitmaps.
                    if (showApps.containsKey(app.getApplicationInfo().packageName)) {
                        Log.e("yyc", "yyc app name " + app.getApplicationInfo().packageName);
