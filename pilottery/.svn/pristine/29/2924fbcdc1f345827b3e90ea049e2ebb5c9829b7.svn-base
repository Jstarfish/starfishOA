...
public class OutletAcctServiceImpl implements OutletAcctService {
	...
	@Override
	public Integer getAdjustmentRecordCount(OutletAcctForm form) {
		return outletAccDao.getAdjustmentRecordCount(form);
	}

	@Override
	public List<OutletAccount> getAdjustmentRecordList(OutletAcctForm form) {
		return outletAccDao.getAdjustmentRecordList(form);
	}

	@Override
	public AdjustmentRecord getCertificateInfoForAdjust(String fundNo) {
		return outletAccDao.getCertificateInfoForAdjust(fundNo);
	}
