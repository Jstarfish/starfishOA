		...
		<div class="border">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td>1st Entry Clerk : ${userMap[gameIssue.firstDrawUserId]}</td>
					<td>2nd Entry Clerk ：${userMap[gameIssue.secondDrawUserId]}</td>
				</tr>
			</table>
		</div>
	</div>
		...
		<div>
			<c:if test="${drawInfoSize == 0}">
			  ...
			  <c:if test="${drawInfoSize > 0}">
	        	<table class="datatable" width="95%" border="0" cellspacing="0" cellpadding="5" style="font-size:14px;table-layout:fixed">
		        	<tr class="headRow">
			        	<td width="20%" align="center">Agency Code</td>
			        	<td width="20%" align="center">Agency Name</td>
