...
function isNull(data) {
	...
	function updateView() {
		...
		if (!doCheck("password0", !isNull($("#password0").val()), "Please enter the old password")) {
			return false;
		}
	...
	<form action="marketManagerPwd.do?method=ChangePwd" id="changePwd" method="post">
		<div class="pop-body">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<div id="title">Change Trans Password</div>
				<tr>
				...
				<tr>
					<td align="right"></td>
					<td align="left"><input id="okButton" type="button" value='Submit' class="button-normal"
