...
<body>
<form modelAttribute="expirydateForm" action="fbsPayout.do?method=insertWinnerInfo" method="post"  onsubmit="return doSubmit();" id="expirydateForm" name="expirydateForm" >
  <%-- <form:hidden path="payagencycode"/> --%>
  <input type="hidden" name="payagencycode">
<div id="title">FBS中心兑奖  </div>
<div id="mainDiv">
    ...
    <div class="xd" style="width:850px">
        <span class="zi" style="margin-left: 70px;">&nbsp;&nbsp;&nbsp;1.查询</span>
