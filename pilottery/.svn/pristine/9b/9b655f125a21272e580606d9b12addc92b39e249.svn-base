	...
	<div class="pop-body">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding:0 20px;">
			...
			<tr>
				...
				<td width="*%" align="left" colspan="3">
					<c:if test="${details.status == 1}">Operational</c:if>
					<c:if test="${details.status == 2}">Deleted</c:if>
					<c:if test="${details.status == 3}">Checking</c:if>
				</td>
			</tr>
			<tr>
		...
		<div style="padding:0 20px; margin-top:10px;margin-bottom:30px;">
			<table style="width:100%" class="datatable">
				<tr>
					<th width="1px">&nbsp;</th>
					<th width="24%">Manager Code</th>
					<th width="2%">|</th>
					<th width="24%">Manager Name</th>
					<th width="2%">|</th>
					<th width="24%">Real Name</th>
					<th width="2%">|</th>
					<th width="*%">Contact Phone</th>
				</tr>
