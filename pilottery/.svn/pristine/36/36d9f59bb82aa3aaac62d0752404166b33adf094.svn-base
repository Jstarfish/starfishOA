...
<head>
    ...
    <script type="text/javascript">
        function doDraw() {
            ...
            var url = "fbsDraw.do?method=submitFbsDraw2Server";
...
<div id="mainDiv">
    ...
    <div class="xd" style="width:850px">
        ...
        <span class="zi" style="margin-left: 25px;">3.显示比赛结果</span>
                ...
                <td align="left" valign="middle">
                    <div class="tab" style="height:400px;">
                        <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" class="tabxian">
                            <tbody>
                            <tr>
                                <td class="tit"><span style="font-size: 24px;">3. 显示比赛结果</span></td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <form id="calculateForm" method="post">
                                        <table border="0" width="85%" align="center" cellpadding="0" cellspacing="0"
                                            ...
                                            <input type="hidden" name="score310" value="${fbsMatch.score310}">
                                            <input type="hidden" name="score30" value="${fbsMatch.score30}">
                                            <tbody>
                                            <c:if test="${fbsDrawForm.secondfhHomeScore!=99}">
                                                <tr>
                                                ...
                                                <tr>
                                                    <td height="30px" class="xh">胜平负过关(让球):</td>
                                                    <td height="30px" align="left"><span
                                                            id="score310">${full310Result}</span></td>
                                                    <td height="30px" class="xh">胜负过关(让球):</td>
                                                    <td height="30px" align="left"><span
                                                            id="score30">${full30Result}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                            ...
                                            <c:if test="${fbsDrawForm.secondfhHomeScore==99}">
                                                <tr>
                                                    <td height="150px" align="center">比赛取消</td>
                                                </tr>
                                            </c:if>
                                            </tbody>
                                        </table>
                                    ...
                                    <div align="center">
                                        <input id="okBtn" type="button" value="下一步" onclick="doDraw();"
                                               class="button-normal"/>
                                    </div>
                                </td>
                            </tr>
