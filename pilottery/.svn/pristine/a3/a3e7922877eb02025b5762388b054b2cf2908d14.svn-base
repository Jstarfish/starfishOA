    ...
    <div id="bodyDiv">
        ...
        <c:forEach var="obj" items="${list}">
            <tr class="dataRow">
                ...
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:9%"><fmt:formatNumber value="${obj.beginTickets }"/></td>
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:9%"><fmt:formatNumber value="${obj.receiptTickets }"/></td>
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:9%"><fmt:formatNumber value="${obj.issueTickets }"/></td>
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:9%"><fmt:formatNumber value="${obj.salesTickets }"/></td>
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:9%"><fmt:formatNumber value="${obj.returnTickets }"/></td>
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:9%"><fmt:formatNumber value="${obj.damageTickets}"/></td>
                <td width="1%" noExp="true">&nbsp;</td>
