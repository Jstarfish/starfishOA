    ...
    <div class="queryDiv">
        <form action="item.do?method=listDamagedItems" method="POST" id="itemDamageQueryForm">
            <div class="left">
	   			...
	   			<span>Register Date: <input id="damageDateQuery" name="damageDate" value="${itemDamageQueryForm.damageDate}" class="Wdate text-normal" onfocus="WdatePicker({lang:'en',dateFmt:'yyyy-MM-dd',readOnly:true,isShowClear:true,isShowToday:true})" maxlength="40"/></span>
