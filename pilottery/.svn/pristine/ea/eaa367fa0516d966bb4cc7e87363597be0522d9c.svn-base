...
function newPurchaseOrder(){
	showBox('order.do?method=initPurchaseOrder','新增订单',650,800);
}

function showDetails(orderNo){
	showBox('order.do?method=purchaseDetail&purchaseOrderNo=' + orderNo,'订单明细',650,800);
}

function editOrder(orderNo){
	showBox('order.do?method=initPurchaseOrderEdit&purchaseOrderNo=' + orderNo,'修改订单',650,800);
}
                ...
                <td>
                    <table class="datatable">
                        <tr class="headRow">
                            ...
                            <th width="1%">|</th>
                            <td style="width:8%">总张数 (tickets)</td>
                            <th width="1%">|</th>
