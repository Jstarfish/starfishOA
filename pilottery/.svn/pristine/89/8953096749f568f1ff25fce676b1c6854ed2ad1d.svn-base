...
public class IssueManagementController {
	...
	public String issueParam(HttpServletRequest request, ModelMap model, Short gameCode, Long issueNumber) {
		...
		} else if (gameInfo.getGameCode() == SysConstants.KOC11X5 || gameInfo.getGameCode() == SysConstants.KOCK3 && riskParam != null) {
			String[] temp = riskParam.split("#");
		...
		}else if (gameInfo.getGameCode() == SysConstants.KOCSSC || gameInfo.getGameCode() == SysConstants.KOCK3 && riskParam != null) {
