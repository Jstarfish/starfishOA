	...
	<div id="box" style="margin-top:35px;position: relative; width: 100%; z-index: 1; overflow-y: scroll;">
		<table class="datatable" id="exportPdfData">
			...
			<tr class="dataRow">
				...
				<td width="1%" noExp="true">&nbsp;</td>
				<td width="15%" ><fmt:formatNumber value="${item.bigPayCount}" type="number"/></td>
				<td width="1%" noExp="true">&nbsp;</td>
				<td width="15%" style="text-align:right;"><fmt:formatNumber value="${item.bigPayAmount}" type="number"/></td>
				<td width="1%" noExp="true">&nbsp;</td>
				<td width="15%" style="text-align:right;"><fmt:formatNumber value="${item.smallPayAmount}" type="number"/></td>
				<td width="1%" noExp="true">&nbsp;</td>
			...
			<tr class="dataRow" bgcolor="#F8F8FF">
				...
				<c:if test="${!empty resultSum}">
					...
					<td width="1%" noExp="true">&nbsp;</td>
					<td ><fmt:formatNumber value="${resultSum.bigPayCount}" type="number"/></td>
					<td width="1%" noExp="true">&nbsp;</td>
					<td style="text-align:right;"><fmt:formatNumber value="${resultSum.bigPayAmount}" type="number"/></td>
					<td width="1%" noExp="true">&nbsp;</td>
					<td style="text-align:right;"><fmt:formatNumber value="${resultSum.smallPayAmount}" type="number"/></td>
					<td width="1%" noExp="true">&nbsp;</td>
