...
var hint = '* Please select a terminal or a region!';//选择区域或输入终端机编码
var hint2 = '* Please select a terminal or a region!';
				...
				<tr>
				  ...
				  <tr>
				    ...
				    <td align="center">
				     ...
				     <td><span id="termCodesTip" class="tip_init">* 12-digit integer, separated by comma for multiple terminals</span></td>
				  </tr>
				  <tr>
