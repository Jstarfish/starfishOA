		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<form:input type="text" path="user.birthday" id="birthday" name="birthday"
					value="${user.birthday}" class="Wdate text-big" onfocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd',readOnly:true})" /></td>
			...
			<tr>
				...
				<td align="center"><form:textarea path="user.remark" id="remark" class="text-big remark" 
