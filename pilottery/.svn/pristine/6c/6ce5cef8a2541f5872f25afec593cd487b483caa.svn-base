				...
				<td class="title4"><table id="butt" width="100%" border="0" cellspacing="0" cellpadding="0" style="color:#fff;font-size:18px;">
					<tr>
						...
						<td width="31%" align="right" >
							<input type="checkbox" id="ch_emails" name="ch_emails" data-on="On" data-off="Off" checked="checked" style="display:none;">
			...
			<tr>
				<td class="nr">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:14px; color:#5e6d81; line-height:30px;">
						...
						<tr>
							<td>${ruleMap[row.paramA]}</td>
							<td><fmt:formatNumber type="number" value="${row.paramB}" /></td> 
						</tr>
						</c:forEach>
						</c:if>
					</table>
