    ...
    <div class="CPage">
        <table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td align="right">
                    <a href="gameDraw.do?method=sendPrizeAmount&gameCode=${gameDrawInfo.gameCode}&issueNumber=${gameDrawInfo.issueNumber}">
            ...
            <tr height="60">
                <td align="center" valign="middle">
                   ...
                   <a href="gameDraw.do?method=restart&gameCode=${gameDrawInfo.gameCode}&issueNumber=${gameDrawInfo.issueNumber}">
                       <img src="views/oms/game-draw/img/refresh1.png" width="102" height="29" id="refreshBtn" />
                   </a> -->
