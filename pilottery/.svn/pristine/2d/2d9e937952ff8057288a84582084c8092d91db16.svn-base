...
<html>
<head>
<title><!--终端上线折线图-->Online Terminals Line Chart</title>
...
<script type="text/javascript" charset="UTF-8" > 
	...
	function drawGraph(dataList) {
	    ...
	    for(var i = 0; i < dataList.length; i++) {
	    	...
	    	timeArray[i] = dataList[i].calcTime;
	    ...
	    $('#container').highcharts({
	        ...
	        title: {
	            text: 'Rate of Online Terminals  '//终端机上线率记录
	        },
	        subtitle: {
                text: getCurrentDate()
            },
			xAxis: {  //x轴 
	        	title: {text: 'Time'}, //标题 //properties---时间
	        	labels:{
	                step:6
	            } ,
...
<body>
	<div id="title">Terminals Online Rate</div>
	<div id="viewdata">
