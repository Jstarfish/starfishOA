						...
						<tr name="itemCheckRow">
							...
							<td width="22%">
								<c:if test="${not empty data.checkQuantity}">
									<input id="checkQuantity" name="itemDetails[${status.index}].checkQuantity" value="${data.checkQuantity}" oninput="filterInput(this);initQuantity();" onpropertychange="filterInput(this);initQuantity();" maxLength="7"/>
								</c:if>
								<c:if test="${empty data.checkQuantity}">
									<input id="checkQuantity" name="itemDetails[${status.index}].checkQuantity" oninput="filterInput(this);initQuantity();" onpropertychange="filterInput(this);initQuantity();" maxLength="7"/>
								</c:if>
