			...
			<div id="main">
				<div class="jdt">
					<img src="views/inventory/goodsReceipts/images/jdt3_2.png" width="1000"
						height="30" />
					<div class="xd">
						<span></span><span class="zi">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.Input Security Code</span><span class="zi">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.Ticket Information</span><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.Complete Personal Information</span>
					</div>
				</div>
				<div class="bd">
											...
											<tr>
												<td>
													<table border="0" cellpadding="0" cellspacing="0" height="100%"
														...
														<tr>
															<td class="lz1" width="35%">Plan name and batch no:</td>
															<td width="35%">${packInfo.planName}&nbsp;&nbsp;&nbsp;${packInfo.batchCode}
															<td width="13%"></td>
														</tr>
														<tr>
															<td class="lz1">Ticket Information :</td>
															<td width="35%">${trunkBox}
															<td width="13%"></td>
														</tr>
														<tr>
															<td class="lz1">Winner Amount :</td>
															<td width="35%"><fmt:formatNumber value="${amount}" />
															<td width="13%"></td>
														</tr>
														<tr>
															<td colspan="4">
																<div style="margin-top: 10px;margin-right:40px; float: right;">
																	<button type="button" class="gl-btn2" onclick="doSubmit()">Next</button>
																</div>
															</td>
														</tr>
													</table>
