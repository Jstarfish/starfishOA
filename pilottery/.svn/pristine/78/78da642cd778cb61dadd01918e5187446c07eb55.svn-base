		...
		<form action="report.do?method=getPayoutReport" id="queryForm" method="post">
			<div class="left">
				...
				<span>Plan: <select name="planCode" class="select-normal">
					...
					onfocus="WdatePicker({lang:'en',dateFmt:'yyyy-MM-dd',readOnly:true})" /> - <input
				...
				<td>
					<table class="datatable" id="exportPdf">
						<tr class="headRow">
							...
							<td width="1%" noExp="true">|</td>
							<td style="width: 7%">Plan Name</td>
							<td width="1%" noExp="true">|</td>
							<td style="width: 7%">1 Prize(riels)</td>
							<td width="1%" noExp="true">|</td>
							<td style="width: 7%">2 Prize(riels)</td>
							<td width="1%" noExp="true">|</td>
							<td style="width: 7%">3 Prize(riels)</td>
							<td width="1%" noExp="true">|</td>
							<td style="width: 7%">4 Prize(riels)</td>
							<td width="1%" noExp="true">|</td>
							<td style="width: 7%">5 Prize(riels)</td>
							<td width="1%" noExp="true">|</td>
							<td style="width: 7%">6 Prize(riels)</td>
							<td width="1%" noExp="true">|</td>
							<td style="width: 7%">7 Prize(riels)</td>
							<td width="1%" noExp="true">|</td>
							<td style="width: 7%">8 Prize(riels)</td>
							<td width="1%" noExp="true">|</td>
							<td style="width: 7%">Other Prize(riels)</td>
							<td width="1%" noExp="true">|</td>
