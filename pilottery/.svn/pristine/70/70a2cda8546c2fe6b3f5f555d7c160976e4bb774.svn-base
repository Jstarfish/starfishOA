...
public class CheckInputActivity extends ScanActivity implements OnClickListener,RequestListener, OnItemClickListener{
...
//					recordList=result.getJSONArray("recordList");//出货单编号列表
					...
					this.runOnUiThread(new Runnable() {
						...
						public void run() {//更新出货单列表
							Intent intent = new Intent(CheckInputActivity.this, 
									CheckResultActivity.class);
							CheckResultActivity.data = resultData;
	...
	static class MyAdapter extends BaseAdapter {
		CheckInputActivity context=null;
		...
		public MyAdapter(CheckInputActivity cia) {
			context = cia;
		}
