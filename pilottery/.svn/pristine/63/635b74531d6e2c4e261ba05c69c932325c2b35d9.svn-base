...
<title>Returned-Good Receipt Slip</title>
<style>
body {
...
<div id="printDiv">
  <table width="1000" border="0" cellspacing="0" cellpadding="0" align="center"  class="normal" style="margin:30px 20px 0px 60px;">
   <tr>
    ...
    <tr>
        <td colspan="3" style="font-size: 24px;line-height: 80px;border-bottom:2px solid #000;font-weight: bold;text-align:center;">Returned-Good Receipt Slip</td>
    </tr>
   <tr height="80">
    ...
    <tr height="40">
      <td align="left"  colspan="3">Returning Person: ${returnvo.realName }</td>
    </tr>
     <tr height="40">
      <td align="left"  colspan="3">Receiving Unit: ${returnvo.orgName }</td>
    </tr>
    <tr>
