...
<script src="${basePath}/views/system/role/js/roleList.js"></script>
</head>
<body>
	<div class="row base-margin" id="query">
		<ol class="breadcrumb">
			<li><strong><span style="color: #27a0d7">Role List</span></strong></li>
		</ol>
		<form id="queryForm">
			
			<div class="form-group btn-right">
				<button type="button" class="btn btn-primary" id="addBtn" onclick="addRole();">New Role</button>
			</div>
		</form>
	</div>
