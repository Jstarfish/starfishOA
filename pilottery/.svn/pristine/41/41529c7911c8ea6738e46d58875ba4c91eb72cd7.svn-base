...
<body>
    ...
    <div class="queryDiv">
        <form action="repaymentRecord.do?method=listRepaymentRecords" id="queryForm" method="post">
            <div class="left">
                <span>Date:
                    <input name="queryDate" value="${form.queryDate }" class="Wdate text-normal" onfocus="WdatePicker({lang:'en',dateFmt:'yyyy-MM-dd',readOnly:true})"/>
                </span>
                ...
                <td>
                    <table class="datatable">
                        <tr class="headRow">
                            ...
                            <td width="1%">|</td>
                            <td style="width:20%">Repayment Amount</td>
                            <td width="1%">|</td>
                            <td style="width:20%">Balance after Repayment</td>
                            <td width="1%">|</td>
                            <td style="width:*%">Date of Repayment</td>
                        </tr>
                    </table>
                 </td>
                 <!-- 表头和下方数据对齐 -->
