...
<div id="container"> 
  ...
  <div id="main"> 
   <div class="jdt">
      ...
      <div class="xd"><span class="zi">1.选择货物</span><span class="zi">2.扫描货物</span><span class="zi">3.完成收货</span><span class="zi">4.汇总货物</span></div></div>
          <div class="bd">
          ...
          <td ><div class="tab" >
              ...
              <!--列表结束-->
                      ...
                      <div style="margin-top:10px;  float:right; padding:0 20px;">
                       <button class="gl-btn2" type="button" onClick="showPage('goodsReceipts.do?method=printRetrun&refNo=${goodReceiptParamt.returnNo}','打印')" >
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <button class="gl-btn2"  type="button" id="okButton" >完成</button>
