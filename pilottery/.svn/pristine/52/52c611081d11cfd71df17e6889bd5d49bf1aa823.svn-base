...
public class TransferController {
	...
	public String saveStockTransfer(HttpSession session, ModelMap model,StockTransfer order) {
		try {
	...
	public String updateStockTransfer(HttpSession session, ModelMap model,StockTransfer order) {
		try {
			User currentUser = (User)session.getAttribute(SysConstants.CURR_LOGIN_USER_SESSION);
			order.setApplyAdmin(currentUser.getId().shortValue());
