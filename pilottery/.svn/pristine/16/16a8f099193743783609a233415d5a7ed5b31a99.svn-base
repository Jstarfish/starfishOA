...
<body>
    <!-- 顶部标题块 -->
    <div id="title">Outlet Rankings</div>
                ...
                <td>
                    <table class="datatable">
                        <tr class="headRow">
                           ...
                           <!-- <td width="1%">|</td>
                            <td style="width:15%">Sale Tickets</td> --> 
                            <td width="1%">|</td>
                            <td style="width:15%">Sale Amount</td>
                            <td width="1%">|</td>
                            <td style="width:15%">Cancel Amount</td>
                            <td width="1%">|</td>
    ...
    <div id="bodyDiv">
        ...
        <c:forEach var="obj" items="${pageDataList}" varStatus="status" >
            <tr class="dataRow">
                ...
                <!-- <td width="1%">&nbsp;</td>
                <td style="width:15%"><fmt:formatNumber value="${obj.saletickets }" /></td> -->
                <td width="1%">&nbsp;</td>
