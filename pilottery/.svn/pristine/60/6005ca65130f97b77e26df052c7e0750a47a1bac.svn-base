		...
		<div class="cx">
		    ...
		    <div class="right"> 
				  ...
				  <tr style="height:50px;line-height:50px">
				    ...
				    onclick="showBox('user.do?method=editUser','New User',650,800)"/></td>
				    <td align="right">
						&nbsp;
	               	</td>
				  </tr>
        ...
        <table class="datatable" id="exportPdfData">
            ...
            <tr class="dataRow">
				...
				<td style="width:*%" scope="col">
				    <a href="#" onclick="showBox('user.do?method=userDetail&userId=${u.id}','Detail',650,800)">Details</a>
				    |
				    <!-- note: 这里的userId就是和UserController的Long userId绑定的 -->
					<a href="#" onclick="showBox('user.do?method=editUser&userId=${u.id}','Edit',650,800)" >Edit</a>
					|
