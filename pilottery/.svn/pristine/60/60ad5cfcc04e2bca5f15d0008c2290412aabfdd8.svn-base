          ...
          <td ><div class="tab" >
                   ...
                   <c:if test="${differencesAmount>0}">
                      ...
                      <div id="box" style="border:1px solid #ccc;">
                        ...
                        <tr>
                                   ...
                                   <td style="padding-top:20px; " colspan="4">remark:<br/>
                                       <textarea name="remarks" id="remarks" rows="5" class="edui-editor1" value="Fill in the 1-500 character, non mandatory" onfocus="if(this.value=='Fill in the 1-500 character, non mandatory'){this.value='';}"  onblur="if(this.value==''){this.value='Fill in the 1-500 character, non mandatory';}">${whremark.remark}</textarea>
                                   </td>
              ...
              <!--列表结束-->
                      ...
                      <div style="margin-top:10px;  float:right; padding:0 20px;">
                       <button class="gl-btn2" type="button" onclick="showPage('goodsReceipts.do?method=printTranstr&refNo=${goodReceiptParamt.stbNo}','Print')">
                        ...
                        <button class="gl-btn2" id="okButton" type="button" >Finish</button>
