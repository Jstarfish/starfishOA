		...
		<div class="cx">
		    ...
		    <div class="right"> 
				  ...
				  <tr style="height:50px;line-height:50px">
				    ...
				    onclick="showBox('user.do?method=editUser','新建用户',550,800)"/></td>
				    <td align="right">
						&nbsp;
	               	</td>
				  </tr>
        ...
        <table class="datatable" id="exportPdfData">
            ...
            <tr class="dataRow">
				...
				<td style="width:*%" scope="col">
				    <a href="#" onclick="showBox('user.do?method=userDetail&userId=${u.id}','详情',550,800)">详情</a>
				    |
				    <!-- note: 这里的userId就是和UserController的Long userId绑定的 -->
					<a href="#" onclick="showBox('user.do?method=editUser&userId=${u.id}','编辑',550,800)" >编辑</a>
					|
					...
					|
					<a href="#" onclick="showBox('user.do?method=setManageInst&userId=${u.id}','设置管辖机构',550,800)">设置管辖区域</a>
					|
