    ...
    <div class="queryDiv">
        <form action="outletGoods.do?method=outletGoodsList" name="outletGoodsForm" id="outletGoodsForm" method="post">
            <div class="left">
                ...
                <span>日期:
                    <input id="arDate" class="Wdate text-normal" name="arDate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})" value="${outletGoodsForm.arDate }"/>
                </span>
                        ...
                        <tr class="headRow">
                         <td style="width:10px;">&nbsp;</td>
                            ...
                            <td style="width:12%">销售站名称</td>
                               <td width="1%" >|</td>
                            <td style="width:12%">票数(tickets)</td>
                               <td width="1%" >|</td>
                            <td style="width:12%">金额(riels)</td>
                               <td width="1%" >|</td>
