...
public class RepaymentController {
	...
	public String addRepayment(HttpServletRequest request, ModelMap model, @ModelAttribute("newRepaymentForm") NewRepaymentForm newRepaymentForm) throws Exception
	{
		...
		try {
			...
			{
				logger.error("errmsgs:" + LocaleUtil.getUserLocaleErrorMsg(newRepaymentForm.getC_errmsg(), request));
				model.addAttribute("system_message", LocaleUtil.getUserLocaleErrorMsg(newRepaymentForm.getC_errmsg(), request));
