    ...
    <div class="sj">
      ...
      <table id="tb1" width="100%" border="0" cellspacing="0" cellpadding="0"  height="450" >
		  ...
		  <tr>
		    ...
		    <td>&nbsp; &nbsp;<form:input id="planStartHour0" path="planStartHour" class="Wdates input_out" onfocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd HH:mm:ss',readOnly:true});cleanPre();" /><font color="red" size="2">&nbsp;&nbsp;<label id="planStartHour0Notice"></label></font>
		    </td>
		  </tr>
		  <tr>
		    <td align="right"><span class="lz">关闭时间：</span></td>
		    <td>&nbsp; &nbsp;<form:input id="planCloseHour1" path="planCloseHour" class="Wdates input_out"  onfocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd HH:mm:ss',readOnly:true});cleanPre();"/><font color="red" size="2">&nbsp;&nbsp;<label id="planCloseHour1Notice"></label></font>
		    </td>
		  </tr>
		</table>
      </div>
