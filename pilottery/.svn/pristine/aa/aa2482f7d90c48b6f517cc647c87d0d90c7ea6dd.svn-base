            ...
            <div class="right">
                <table width="260" border="0" cellspacing="0" cellpadding="0">
                    <tr style="height:50px;line-height:50px">
                        <td align="right">
                            <input type="button" value="Process Repayment" onclick="showBox('repayment.do?method=addRepaymentInit', 'Process Repayment', 300, 650);" class="button-normal"></input>
                        </td>
                    </tr>
                </table>
            </div>
                ...
                <td>
                    <table class="datatable">
                        <tr class="headRow">
                            ...
                            <td style="width:12%">Repayment Date</td>
                            <td width="1%">|</td>
                            <td style="width:12%">Market Manager Code</td>
                            <td width="1%">|</td>
                            <td style="width:14%">Market Manager Name</td>
                            <td width="1%">|</td>
                            <td style="width:14%">Before Repayment</td>
                            <td width="1%">|</td>
                            <td style="width:14%">Repay Amount</td>
                            <td width="1%">|</td>
                            <td style="width:14%">After Repayment</td>
                            <td width="1%">|</td>
        ...
        <table class="datatable">
        	<c:forEach var="record" items="${repaymentList}" varStatus="status">
	        	<tr class="dataRow">
	                ...
	                <td width="1%">&nbsp;</td>
	                <td style="width:*%">
	                	<span><a href="#" onclick="showPage('repayment.do?method=printRepaymentCertificate&repaymentDate=${record.repaymentDate}&marketManagerCode=${record.marketManagerCode}&marketManagerName=${record.marketManagerName}&balanceBeforeRepayment=${record.balanceBeforeRepayment}&repaymentAmount=${record.repaymentAmount}&balanceAfterRepayment=${record.balanceAfterRepayment}','Print Repayment Certificate');">Print</a></span>
	                </td>
	            </tr>
        	</c:forEach>
        </table>
