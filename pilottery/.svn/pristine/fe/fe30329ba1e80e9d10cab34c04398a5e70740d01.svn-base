    ...
    <div class="queryDiv">
		<form action="inventory.do?method=listInventoryCheck" id="checkPointForm" method="post">
			<div class="left">
				<span>
					Date: 
					<input id="cpDate" name="cpDate" class="Wdate text-normal" style="width:150px;" value="${checkPointForm.cpDate }" onfocus="WdatePicker({lang:'en',dateFmt:'yyyy-MM-dd',readOnly:true})"/>
				</span> 
				<span>
					Warehouse: 
			...
			<div class="right">
				<table width="150px" border="0" cellspacing="0" cellpadding="0">
					<tr style="height: 50px; line-height: 50px">
						<td align="right">
							<input type="button" value="New Check" onclick="showBox('inventory.do?method=addInit','New Inventory Check',400,550);" class="button-normal"></input>
						</td>
					</tr>
				</table>
			</div>
