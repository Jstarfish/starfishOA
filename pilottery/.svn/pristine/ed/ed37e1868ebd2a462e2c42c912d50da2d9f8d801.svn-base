...
begin
   ...
   for itab in (select * from table(v_out)) loop
...
{
    "type":1,
    "applyflow_sell":"12345678901234567890123A",
    "terminal_code":1,
    "teller_code":1,
    "agency_code":1,
    "ticket": {
...
{
    "type":2,
    "applyflow_cancel":"A2345678901234567890123A",
    "terminal_code":1,
    "teller_code":1,
    "agency_code":1,
    "ticket": {
...
declare
  -- Non-scalar parameters require additional processing
  p_game_auth_list type_game_auth_list;
  v_game_auth_info type_game_auth_info;
begin
  p_game_auth_list := type_game_auth_list();

  v_game_auth_info := type_game_auth_info(11, 88, 1, 10, 100, 0, 1, 1, 1, 0);
  p_game_auth_list.extend;
  p_game_auth_list(p_game_auth_list.count) := v_game_auth_info;

  v_game_auth_info := type_game_auth_info(5, 88, 1, 10, 100, 0, 1, 1, 1, 0);
  p_game_auth_list.extend;
  p_game_auth_list(p_game_auth_list.count) := v_game_auth_info;

  v_game_auth_info := type_game_auth_info(6, 88, 1, 10, 100, 0, 1, 1, 1, 0);
  p_game_auth_list.extend;
  p_game_auth_list(p_game_auth_list.count) := v_game_auth_info;

  -- Call the procedure
  p_om_area_auth(p_game_auth_list => p_game_auth_list,
                 c_errorcode => :c_errorcode,
                 c_errormesg => :c_errormesg);
end;
