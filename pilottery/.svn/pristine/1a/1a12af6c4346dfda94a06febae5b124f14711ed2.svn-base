    ...
    <div class="queryDiv">
        <form action="repayment.do?method=listRepayment" method="POST" id="repaymentQueryForm">
            <div class="left">
	   			...
	   			<span>还款日期: </span>
	   			<span><input id="repaymentDate" name="repaymentDate" value="${repaymentQueryForm.repaymentDate}" class="Wdate text-normal" onfocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd',readOnly:true,isShowClear:true,isShowToday:true})"/></span>
            ...
            <div class="right">
                <table width="260" border="0" cellspacing="0" cellpadding="0">
                    <tr style="height:50px;line-height:50px">
                        <td align="right">
                            <input type="button" value="还款操作" onclick="showBox('repayment.do?method=addRepaymentInit', '还款操作', 360, 650);" class="button-normal"></input>
                        </td>
                    </tr>
                </table>
            </div>
                ...
                <td>
                    <table class="datatable">
                        <tr class="headRow">
                            ...
                            <td style="width:11%">还款日期</td>
                            <td width="1%">|</td>
                            <td style="width:11%">市场管理员编号</td>
                            <td width="1%">|</td>
                            <td style="width:11%">市场管理员名称</td>
                            <td width="1%">|</td>
                            <td style="width:11%">还款前账户余额</td>
                            <td width="1%">|</td>
                            <td style="width:11%">还款金额</td>
                            <td width="1%">|</td>
                            <td style="width:11%">还款后账户余额</td>
                            <td width="1%">|</td>
        ...
        <table class="datatable">
        	<c:forEach var="record" items="${repaymentList}" varStatus="status">
	        	<tr class="dataRow">
	                ...
	                <td width="1%">&nbsp;</td>
	                <td style="width:11%;" title='${record.remark}'>${record.remark}</td>
	                <td width="1%">&nbsp;</td>
	                <td style="width:*%">
	                	<span><a href="#" onclick="showPage('repayment.do?method=printRepaymentCertificate&repaymentDate=${record.repaymentDate}&marketManagerCode=${record.marketManagerCode}&marketManagerName=${record.marketManagerName}&balanceBeforeRepayment=${record.balanceBeforeRepayment}&repaymentAmount=${record.repaymentAmount}&balanceAfterRepayment=${record.balanceAfterRepayment}&remark=${record.remark}','打印还款凭证');">打印</a></span>
	                </td>
	            </tr>
        	</c:forEach>
        </table>
