...
NCPLOGSYNCPATH=/backupdata/kpw/ncp_webncp_log
TAR_PATH_HOST=/backupdata/kpw/tarback/host
TAR_PATH_NCP=/backupdata/kpw/tarback/ncp
...
################################# tidx_data ##################################################
tar -jcvf ${TAR_PATH_HOST}/tidx_data_${todate}_${timestamp}.tar.bz2 ${TSBACKPATH}/data/tidx_data
myecho $? "tidx data"
...
find $TAR_PATH_HOST -type f -name "tidx_data_*.bz2" -ctime +$DEALDATA_DELETE_DAYS -exec rm -f {} \;
