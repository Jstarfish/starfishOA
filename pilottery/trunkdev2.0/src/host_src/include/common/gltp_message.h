...
#include "gltp_message_oms.h"
#include "gltp_message_terminal.h"

#include "gltp_message_notify.h"
...
typedef enum _SYS_RESULT_TYPE
{
    ...
    SYS_RESULT_SELL_BETLINE_ERR = 21,               //彩票销售超过最大行数(场次)限制
    ...
    // FBS ------------
    SYS_RESULT_FBS_PAY_MULTI_MATCH_ERR = 70,        //所有场次开奖完成才可兑奖
    SYS_RESULT_FBS_MATCH_ERR = 71,                  //场次错误(状态，数量)
