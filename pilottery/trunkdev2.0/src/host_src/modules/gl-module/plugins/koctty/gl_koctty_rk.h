...
#define KOCTTY_BC_BITMAP_MAX 1024
#define KOCTTY_BC_COUNT_MAX 1680

#define KOCTTY_BD_2D_MAX 100
#define KOCTTY_BD_3D_MAX 1000
#define KOCTTY_BD_4D_MAX 10000
#define KOCTTY_BD_COUNT_MAX 24
...
typedef struct _KOCTTY_BETBD_INDEX
{
	uint16 numCount;
    uint16 numArray[KOCTTY_BD_COUNT_MAX];

}KOCTTY_BETBD_INDEX;

typedef struct _KOCTTY_BETBC_TABLE
{
	KOCTTY_BETBC_INDEX twoStarBC[KOCTTY_BC_BITMAP_MAX];
	KOCTTY_BETBC_INDEX threeStarBC[KOCTTY_BC_BITMAP_MAX];
	KOCTTY_BETBC_INDEX fourStarBC[KOCTTY_BC_BITMAP_MAX];
