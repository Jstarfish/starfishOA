...
function newDeliveryOrder(){
	showBox('delivery.do?method=initDeliveryOrderAdd','新增出货单',550,800);
}
function editOrder(orderId){
	showBox('delivery.do?method=initDeliveryOrderEdit&deliveryOrderNo=' + orderId,'修改出货单',550,800);
}
...
function cancelOrder(orderId,status) {
	...
	showDialog("doCancel('"+url+"')",'取消','取消出货单 : '+orderId);
}
