...
function edit(seq){
	...
	if(obj.length > 0){
		showError('Please save other parameters！');
		return false;
	};
...
function prompt(seq) {
	...
	showDialog("update('"+seq+"')","Confirm",msg);
}
function update(seq){
...
<body>
<div id="title">Rolling Subtitles</div>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td class="title">
								<table width="100%" border="0" cellspacing="0"
									...
									<tr>
										<td>Lucky5 Rolling Subtitles 1</td>
						...
						<tr>
							<td class="nr" style="height: 220px; white-space:normal">
								<div
									style="margin: 0 auto; width: 460px; word-wrap: break-word;">
									${scrollingNotice1}
								</div>
							</td>
						</tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<table width="100%" border="0"
									...
									<tr>
										<td>Lucky5 Rolling Subtitles 2</td>
										<td align="right"><a href="#"
						...
						<tr>
							<td class="title2">
								<table width="100%" border="0" cellspacing="0" cellpadding="0"
									style="color: #fff; font-size: 18px;">
									<tr>
										<td>Lucky5 Rolling Subtitles 3</td>
										<td align="right"><a href="#"
