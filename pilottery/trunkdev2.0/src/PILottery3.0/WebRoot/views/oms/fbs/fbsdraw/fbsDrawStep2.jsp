...
<head>
    ...
    <script type="text/javascript" charset="UTF-8">
        ...
        function changeFirstTeam(){
            ("#secondScoreTeamTip").val("");
        }
        function checkData() {
            var regType="^\\d+$";
            ...
            if (secondScoreTeam == 0) {
                if (secondfhHomeScore > 0 ||
                    ...
                    document.getElementById("secondScoreTeamTip").innerHTML = 'Choose The Team';
            ...
            if (secondScoreTeam > 0) {
                if (secondfhHomeScore == 0 &&
                        ...
                        secondshHomeScore == 0 &&
                        secondshGuestScore == 0) {
                    document.getElementById("secondScoreTeamTip").innerHTML = 'Enter The Score Number';
                    $("#secondScoreTeamTip").css("color", "red");
                    return false;
                }
            }
            if (Number(secondfhHomeScore) > 0 && Number(secondfhGuestScore) == 0) {
                if (secondScoreTeam !=${fbsMatch.homeTeamCode}) {
                    document.getElementById("secondScoreTeamTip").innerHTML = 'The Score Is Invalid';
                    $("#secondScoreTeamTip").css("color", "red");
                    return false;
                }
            }
                ...
                <td align="left" valign="middle">
                    <div class="tab" style="height:500px;">
                        <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" class="tabxian">
                            <tbody>
                            <tr>
                                <td class="tit"><span style="font-size: 24px;">2.Wait For Result</span></td>
                            </tr>
                            <tr>
                                <td>
