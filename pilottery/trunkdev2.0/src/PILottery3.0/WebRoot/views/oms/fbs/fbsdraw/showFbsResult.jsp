...
<body>
<div id="title">Show Match Result</div>
<div id="mainDiv">
    <div class="jdt"
                            ...
                            <tr>
                                <td>
                                    <table width="90%" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td width="14%" height="30px" class="lzx">
                                                <div align="right">Match Issue:</div>
                                            </td>
                                ...
                                <td>
                                    <form id="calculateForm" method="post">
                                        <table border="0" width="85%" align="center" cellpadding="0" cellspacing="0"
                                            ...
                                            <c:if test="${fbsDrawForm.secondfhHomeScore==99}">
                                                <tr>
                                                    <td height="150px" align="center">Match Canceled</td>
                                                </tr>
                                            </c:if>
                                            </tbody>
                                        </table>
                                    ...
                                    <div align="center">
                                        <input id="okBtn" type="button" value="Next Step" onclick="doDraw();"
                                               class="button-normal"/>
                                    </div>
                                </td>
                            </tr>
