	...
	<table border="0" cellspacing="0" cellpadding="0" width="600" height="100px" style="background:#fff;padding:40px 0px;margin-top:50px; border:1px solid #f1f1f1;">
		<tr>
			...
			<td align="left" style="padding: 0px 20px 0px 10px;">
				<c:if test="${not empty system_message}">No Data Exist：${system_message}</c:if>
				<c:if test="${empty system_message}">No Data Exist</c:if>
			</td>
		</tr>
		...
		<tr>
			...
			<td style="padding-left:10px;">
				<input type="button" value="Confirm" class="button" onclick="doReload()"></input>
			</td>
		</tr>
	</table>
</div>
