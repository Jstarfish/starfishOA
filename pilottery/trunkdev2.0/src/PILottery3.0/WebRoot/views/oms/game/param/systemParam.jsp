...
<body>
<div id="title">System Parameters</div>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td class="title1"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="color:#fff;font-size:18px;">
										<tr>
											<td>Outlet Default Parameters</td>
											<td align="right"><a href="#"
												onclick="edit('agency');"
												onmouseout="MM_swapImgRestore()"
									...
									<table width="100%" border="0" cellspacing="0"
										...
										<tr>
											<td>Payout Claiming Scope：
												<c:if test="${gameManagementForm.str_sysParamValue6==1}">Center</c:if> 
												<c:if test="${gameManagementForm.str_sysParamValue6==2}">1st-level Institution</c:if> 
												<c:if test="${gameManagementForm.str_sysParamValue6==3}">2nd-level Institution</c:if> 
												<c:if test="${gameManagementForm.str_sysParamValue6==4}">Outlet</c:if> 
											</td>
										</tr>
										<tr>
