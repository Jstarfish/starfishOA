...
<div id="gameParameter">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<td class="title2">
			...
			<tr>
			    <td width="51%">服务时段</td>
			    <td width="37%" align="right"><a href="#" onclick="editGameParameter(${gameManagementForm.gameParameterDynamic.gameCode},3);" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image7','','${basePath}/img/edit-hover.png',1)"><img src="${basePath}/img/edit.png" width="32" height="42" id="Image7" title="编辑" /></a></td>
			</tr>
		    </table>
		</td>
	    </tr>
