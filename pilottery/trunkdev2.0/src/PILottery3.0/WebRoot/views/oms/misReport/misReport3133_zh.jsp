...
<body style="overflow: hidden;">
	<div id="title"><!-- 兑奖统计表(按奖等统计) -->兑奖期次统计表(按奖等统计)</div>
			...
			<form:form id="form" modelAttribute="misReportForm" action="misReport.do?method=misReport3133&init=false">
				...
				<div style="overflow: right;">
	            	<span style="position: absolute;right: 80px;">
		        		<input type="hidden" id="reportTitle" name="reportTitle" value="兑奖统计表(按奖等统计)">
		            	<!-- 
			...
			<table class="datatable" id="exportPdf">
			  <thead>
				<tr class="headRow">
					...
					<td width="1%" noExp="true">|</td>
					<td width="15%"><!--高等奖兑奖注数-->高等奖兑奖注数</td>
					<td width="1%" noExp="true">|</td>
					<td width="15%"><!--高等奖兑奖金额-->高等奖兑奖金额</td>
					<td width="1%" noExp="true">|</td>
					<td width="15%"><!--低等奖兑奖金额-->低等奖兑奖金额</td>
					<td width="1%" noExp="true">|</td>
