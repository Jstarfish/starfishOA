...
function doSubmit(){
	...
	if(!doCheck("terminalCode",!terminalCode.value == "",'* terminal code cannot be empty!')) {//
	    result = false;
	}
	
	if(!doCheck("applyArg1",!applyArg1.value == "",'* extension parameter cannot be empty!')) {//
	    result = false;
	}
    ...
    <form action="trace.do?method=addTrace" method="POST" id="addForm">
        <div class="pop-body">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                <tr>
                    <td class="td" align="right" width="30%">Terminal Code：</td>
             ...
             <tr>
				<td class="td" align="right">Application Type：</td>
                ...
                <tr>
				<td class="td" align="right">Extension Parameter：</td>
		...
		<span class="right">			
			<input type="button" value="reset" onclick="doClose();" class="button-normal"></input>
		</span>
	</div>
</form>
</body>
