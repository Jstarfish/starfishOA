...
<body>
<form:form modelAttribute="expirydateForm" action="centerSelect.do?method=printInfo" method="post" id="expirydateForm"
           name="expirydateForm">
    <form:hidden path="carId"/>
    <div id="title">Payout at Center</div>
    <div id="mainDiv">
        <div class="jdt" style="background: url(views/oms/game-draw/img/zxdjbj-4.png) no-repeat left top;width:850px;">
        </div>
        <div class="xd" style="width:650px">
            <span>1.Ticket Inquiry</span>
            <span>2.Winning Data Entry</span>
            <span>3.Winning Information</span>
            <span class="zi" style="margin-left: 20px;">4.Print Payout Form</span>
        </div>
        <div class="CPage">
                    ...
                    <td width="820" align="left" valign="middle">
                        <div class="tab">
                            <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
                                ...
                                <tr>
                                    <td width="130" align="right"><img
                                            src="<%=request.getContextPath() %>/img/right.png" width="49" height="49"/>
                                    </td>
                                    <td width="170" colspan="2" align="left"><span
                                            style="font-size:18px; text-align:left;">Payout Complete!</span>
                                    </td>
                                </tr>
                                <tr>
