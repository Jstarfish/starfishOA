...
<link type="text/css" rel="stylesheet" href="${basePath}/views/oms/oms/game-draw/css/myStyle.css" />
<script type="text/javascript" src="${basePath}/views/oms/oms/game-draw/js/myJs.js"></script>
