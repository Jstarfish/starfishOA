...
<script type="text/javascript">
	...
	function getData() {
	    $.ajax({
	        ...
	        success: function (obj) {//alert(status);
	...
	if( status == 12) {
		window.location.href="gameDraw.do?method=prizeStatistic&gameCode=${gameDrawInfo.gameCode}&issueNumber=${gameDrawInfo.issueNumber}";
	}
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%;">
                            ...
                            <tr>
                                <td align="center" height="80">
                                    <span style="color: #cac9c9;text-shadow: 1px 1px 1px #fff;">Generating winning statistics, please wait...</span>
                                </td>
                            </tr>
                            <tr></tr>
                        </table>
