...
<script type="text/javascript" charset="UTF-8">
	$().ready(function(){
		$('#agencyType').val('${listForm.agencyType }');
	});
	...
	function doSubmit() {
		...
		if (!doCheck("agencyName", !isNull(trim($("#agencyName").val())),
				'Not empty, start with an English letter or a Chinese character')) {
			result = false;
		}
	...
	<form action="outlets.do?method=modify" id="theArea" method="POST">
		...
		<div class="pop-body">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td align="right" width="25%">Market Managers：</td>
				...
				<tr>
					<td align="right" width="25%">Store Type：</td>
				...
				<tr>
					<td align="right" width="25%">Outlet Type：</td>
				...
				<tr>
					<td align="right" width="25%">Partnership Bank：</td>
		...
		<div class="pop-footer">
			<span class="left"><input id="okBtn" type="button" value="Modify"
				onclick="doSubmit();" class="button-normal"></input></span> <span class="right"><input
				type="button" value="Close" onclick="doClose();" class="button-normal"></input></span>
		</div>
	</form>
</body>
</html>