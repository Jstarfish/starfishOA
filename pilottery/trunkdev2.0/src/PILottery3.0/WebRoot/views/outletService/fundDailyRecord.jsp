...
<body>
	<!-- 顶部标题块 -->
	<div id="title">Fund Daily Record</div>
		...
		<form action="outlets.do?method=fundDailyRecord" method="POST" id="dealRecordForm">
			<div class="left">
				<span>Outlet Code: <input id="outletCode" name="outletCode"
					class="text-normal" maxlength="40" value="${agencyForm.outletCode }"/></span> <span>Date: <input id="beginTime"
					name="beginTime" class="Wdate text-normal" value="${agencyForm.beginTime }"
					onfocus="WdatePicker({lang:'en',dateFmt:'yyyy-MM-dd',readOnly:true,maxDate:'%y-%M-{%d}'})" readonly="readonly"
					type="text" />
				...
				<td>
					<table class="datatable">
						<tr class="headRow">
							...
							<td width="1%">|</td>
							<td style="width: 20%">Account(riels)</td>
							<td width="1%">|</td>
