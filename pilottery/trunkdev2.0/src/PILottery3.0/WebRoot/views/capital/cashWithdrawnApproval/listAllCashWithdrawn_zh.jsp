    ...
    <div class="queryDiv">
        <form action="cashWithdrawn.do?method=listCashWithdrawn" id="newCashWithdrawnForm" method="post">
            <div class="left">
                ...
                <span>日期:
                    <input id="applyDate" name="applyDate" value="${newCashWithdrawnForm.applyDate }" class="Wdate text-normal" onfocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd',readOnly:true})"/>
                </span>
