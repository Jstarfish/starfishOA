...
<script type="text/javascript" charset="UTF-8">
	...
	function doSubmit() {
		...
		if(select == 1){
			...
			if(specification == 4 && packUnitCode.length != 11){
				showError('Logistics Code Illegal');
				return false;
			}
	...
	<div class="queryDiv">
		<form action="logistics.do?method=initLogistics" id="queryForm" method="POST">
			<div class="center">
				...
				<span id="span1">Logistics Code: <input name="logisticsCode" value="${form.logisticsCode }" id="logisticsCode" class="text-normal" style="width:300px;" maxlength="100" />
				</span> 
				<span id="span2" style="display: none">Plan:
			...
			<div id="bodyDiv">
				<table class="datatable">
					<c:if test="${payout!=null }">
						<tr class="dataRow">
							<td style="width: 10px;">&nbsp;</td>
							<td><fmt:formatDate value="${payout.payoutDate }" pattern="yyyy-MM-dd HH:mm:ss" /></td>
							<td width="1%">&nbsp;</td>
							<td>${payout.outlet}</td>
							<td width="1%">&nbsp;</td>
							<td>Payout </td>
