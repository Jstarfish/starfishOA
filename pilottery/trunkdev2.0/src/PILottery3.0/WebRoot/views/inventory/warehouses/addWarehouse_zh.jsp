...
function genDynamicBox(value) {
	...
	$.ajax({
		...
		success: function(r) {
            ...
            html += '<th width="12%" align="left">用户编码</th>';
            html += '<th width="2%" align="left">|</th>';
            html += '<th width="16%" align="left">登录名称</th>';
            html += '<th width="2%" align="left">|</th>';
            html += '<th width="25%" align="left">真实姓名</th>';
            html += '<th width="2%" align="left">|</th>';
            html += '<th width="15%" align="left">联系电话</th>';
            html += '<th width="2%" align="left">|</th>';
            html += '<th width="10%" style="padding-left:11px;">负责人</th>';
            html += '<th width="2%" align="left">|</th>';
            html += '<th width="*%" style="padding-left:8px;">管理员</th>';
            html += '</tr>';
			...
			if (r != null && r != '') {
				for (var i = 0; i < r.length; i++) {
					...
					html += '<td width="2%">&nbsp;</td>';
					html += '<td width="15%" title="'+r[i].mobilePhone+'">'+(r[i].mobilePhone==null?'空':r[i].mobilePhone)+'</td>';
					html += '<td width="2%">&nbsp;</td>';
...
$(document).ready(function(){
    ...
    $("#okButton").bind("click", function(){
        ...
        if (!doCheck("institutionCode", isNotEmptyString($("#institutionCode").val()), "不可为空")) {
            result = false;
        }
        
        if (!doCheck("warehouseCode", isNotEmptyString($("#warehouseCode").val()), "不可为空")) {
            result = false;
        }
    ...
    <form action="warehouses.do?method=addWarehouse" id="newWarehouseForm" method="POST">
        <div class="pop-body">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td align="right" width="25%">组织机构：</td>
                ...
                <tr>
                    <td align="right" width="25%">仓库编号：</td>
                    <td align="left" width="30%">
                ...
                <tr>
                    <td align="right" width="25%">仓库名称：</td>
                    <td align="left" width="30%">
                ...
                <tr>
                    <td align="right" width="25%">仓库地址：</td>
                    <td align="left" width="30%">
