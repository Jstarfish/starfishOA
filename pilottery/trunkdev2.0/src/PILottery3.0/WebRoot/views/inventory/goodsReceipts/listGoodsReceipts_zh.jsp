                ...
                <td>
                    <table class="datatable">
                        ...
                        <td style="width:10px;">&nbsp;</td>
                            ...
                            <td width="1%" >|</td>
                            <td style="width:10%">总票数(张)</td>
                              <td width="1%" >|</td>
                            <td style="width:14%">总金额(瑞尔)</td>
                              <td width="1%" >|</td>
                ...
                <a href="#" onclick="showPage('goodsReceipts.do?method=printAll&sgrNo=${data.refNo}&type=${data.receiptType}','打印')">打印</a>&nbsp;|
                    <c:choose>
                          ...
                          <c:when test="${data.status=='2'}">
                                 <c:if test="${data.receiptType == 1 || (data.receiptType == 2 && data.actReceiptTickets != data.receiptTickets) }">
                                	<span><a href="#"  onclick="onFinish('${data.receiptType}','${data.refNo}')">损毁登记</a></span>&nbsp;|
                          		 </c:if>
                          </c:when> 
                          
                    </c:choose>
                     <span><a href="#" onclick="showBox('goodsReceipts.do?method=getGoodsDetailBysgrNo&sgrNo=${data.sgrNo}&refNo=${data.refNo}','详情',550,1000)">详情</a></span>
                </td>
            </tr>
            </c:forEach>
        </table>
