...
<div id="printDiv">
  <table width="1000" border="0" cellspacing="0" cellpadding="0" align="center"  class="normal" style="margin:30px 20px 0px 60px;">
   <tr>
    ...
    <tr>
      <td colspan="3" style="font-size: 24px;line-height: 80px;border-bottom:2px solid #000;font-weight: bold;text-align:center;">Delivery Issue Slip</td>
    </tr>
    <tr height="80">
      <td colspan="3" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr height="40">
      <td align="left"  colspan="3">Delivering Unit:${vo.orgName }</td>
    </tr>
     <tr height="40">
      <td align="left"  colspan="3">Delivering Person: ${vo.sendManger }</td>
    </tr>
    <tr>
      <td colspan="3" style="padding:20px 0;"><table width="1000" border="1" align="center" cellpadding="0" cellspacing="0"  class="normal">
          <tr align="center" height="80">
            ...
            <td width="142" >Face Value(riels)</td>
