...
<div id="container"> 
  ...
  <div id="main" >
   <div class="jdt">
      ...
      <div class="xd-cn"><span class="zi">1.选择出库物品</span><span class="zi">2.扫描出库物品</span><span >3.完成出库</span><span >4.统计出库物品</span></div></div>
    <div class="bd">
          ...
          <td ><div class="tab" >
              <div class="tabn">
                <table  border="0"  cellpadding="0" cellspacing="0" width="100%" valign="top">
                  ...
                  <tr>
                    <td><div class="nr">
                    <div style="margin-bottom:20px;"><span class="dazit" style="font-size:18px;">出货单编号:<span class="hz1">${param.doNo}</span></span></div>
