          ...
          <td ><div class="tab" >
              <div class="tabn">
                <table  border="0"  cellpadding="0" cellspacing="0" width="100%" valign="top">
                  ...
                  <tr>
                    <td>
                    <div style="margin-bottom:20px;"><span class="dazit" style="font-size:18px;">调拨单编号 :<span class="hz1">${stbNo}</span></span></div>
              ...
              <!--列表结束-->
                      ...
                      <div style="margin-top:10px;  float:right; padding:0 20px;">
                       <button class="gl-btn2" type="button" onclick="showPage('goodsIssues.do?method=printStock&refNo=${goodIssuesParamt.sbtNo}','打印')">
                        ...
                        <button class="gl-btn2" type="button"  id="btnok">完成</button>
