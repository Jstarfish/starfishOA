	 ...
	 <c:forEach var="u" items="${pageDataList}" varStatus="status" > 
		<tr class="dataRow">
			...
			<td style="width:*%" scope="col">
				...
				|
				<a href="#" onclick="showBox('role.do?method=addRoleUser&roleId=${u.id}', 'Add Users',550,820);">Add Users</a>
				|
				<a href="#" onclick="showBox('role.do?method=rolePermissions&roleId=${u.id}', 'Role Permissions',550,800);">Permissions</a>
				|
