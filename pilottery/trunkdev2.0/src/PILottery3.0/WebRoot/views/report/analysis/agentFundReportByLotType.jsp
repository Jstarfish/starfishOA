...
<body>
    <!-- 顶部标题块 -->
    <div id="title">Agent Fund Report(By Lottery Type)</div>
            ...
            <div class="left">
             ...
             <div style="overflow: right;">
	        	<span style="position: absolute;right: 80px;">
	        		<input type="hidden" id="reportTitle" name="reportTitle" value="Agent Fund Report(By Lottery Type)">
                ...
                <td>
                    <table class="datatable" id="exportPdf">
                        <tr class="headRow">
                        	...
                        	<td style="width:7%" title="Date">Date</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:9%" title="Agent Name">Agent Name</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:7%" title="Transfer In">Transfer In</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:7%" title="Sales Comm">Sales Comm</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:7%" title="Transfer Out">Transfer Out</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:7%" title="Return Comm">Return Comm</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:7%" title="Payout">Payout</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:7%" title="Payout Comm">Payout Comm</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:7%" title="Center Cancel">Center Cancel</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:7%" title="Cancel Comm">Cancel Comm</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:7%" title="Center Payout">Center Payout</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:*%" title="CPayout Comm">CPayout Comm</td>
                        </tr>
                    </table>
                 </td>
                 <!-- 表头和下方数据对齐 -->
