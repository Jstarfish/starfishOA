...
<title>Outlet Sales Monthly Report</title>
...
<body>
    <!-- 顶部标题块 -->
    <div id="title">Outlet Sales Monthly Report</div>
   
    <!-- 查询条件块 -->
    <div class="queryDiv">
        <form action="monthlyReport.do?method=listOutletMonthlyReport" id="queryForm" method="post">
            <div class="left">
            	<span>Type:
             ...
             <div style="overflow: right;">
	        	<span style="position: absolute;right: 80px;">
	        		<input type="hidden" id="reportTitle" name="reportTitle" value="Outlet Sales Monthly Report">
                ...
                <td>
                    <table class="datatable" id="exportPdf">
                        <tr class="headRow">
                            ...
                            <td width="1%" noExp="true">|</td>
                            <td style="width:10%">Top Up</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:10%">Withdraw</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:10%">Sales Amount</td>
                            <td width="1%" noExp="true">|</td>
    ...
    <div id="bodyDiv">
        ...
        <c:forEach var="obj" items="${list}" varStatus="status" >
            <tr class="dataRow">
                ...
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:10%" title="${obj.agencyCode }">${obj.agencyCode }</td>
                <td width="1%" noExp="true">&nbsp;</td>
