            ...
            <div class="left">
             ...
             <div style="overflow: right;">
	        	<span style="position: absolute;right: 80px;">
	        		<input type="hidden" id="reportTitle" name="reportTitle" value="代理商资金报表">
                ...
                <td>
                    <table class="datatable" id="exportPdf">
                        <tr class="headRow">
                        	...
                        	<td style="width:5%" title="日期">日期</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:7%" title="代理商">代理商</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:5%" title="期初余额">期初余额</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:5%" title="充值">充值</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:5%" title="提现">提现</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:5%" title="调拨入库">调拨入库</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:5%" title="销售佣金">销售佣金</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:5%" title="调拨出库">调拨出库</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:5%" title="退还佣金">退还佣金</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:5%" title="兑奖金额">兑奖金额</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:5%" title="兑奖佣金">兑奖佣金</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:5%" title="中心退票">中心退票</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:5%" title="退票佣金">退票佣金</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:5%" title="中心兑奖">中心兑奖</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:6%" title="中心兑奖佣金">中心兑奖佣金</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:*%" title="期末余额">期末余额</td>
                        </tr>
                    </table>
                 </td>
                 <!-- 表头和下方数据对齐 -->
