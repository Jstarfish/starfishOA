...
public class RefundRes4005Result implements Serializable {
	...
	public String toString() {
		return "Refund4005Result [areaCode_cancel=" + areaCode_cancel + ", cancelAmount=" + cancelAmount + ", commissionAmount=" + commissionAmount + ", gameCode=" + gameCode + ", reqfn_ticket=" + reqfn_ticket + ", reqfn_ticket_cancel=" + reqfn_ticket_cancel + ", rspfn_ticket="
