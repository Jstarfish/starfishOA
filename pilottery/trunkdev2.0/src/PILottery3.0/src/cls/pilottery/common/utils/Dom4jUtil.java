...
public class Dom4jUtil {
	...
	public static void main(String args[]) throws Exception {
		...
		fillConfig(new EnumConfigZH(), "EnumConfig_zh.xml");

		// System.out.println(EnumConfig.agencyStatusItems);
		// System.out.println(ClassLoader.getSystemResource("EnumConfig_ch.xml").toString());
