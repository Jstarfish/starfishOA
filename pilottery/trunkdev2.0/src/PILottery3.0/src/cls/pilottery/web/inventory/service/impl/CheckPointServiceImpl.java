...
public class CheckPointServiceImpl implements CheckPointService {
	...
	@Override
	public Integer getMMCheckInquiryCount(CheckPointForm checkPointForm) {
		return checkPointDao.getMMCheckInquiryCount(checkPointForm);
	}
	@Override
	public List<MMCheckVO> getMMCheckInquiryList(CheckPointForm checkPointForm) {
		return checkPointDao.getMMCheckInquiryList(checkPointForm);
	}
	@Override
	public List<MMCheckDetailVO> getMMInventoryCheckDetail(String cpNo) {
		return checkPointDao.getMMInventoryCheckDetail(cpNo);
	}
