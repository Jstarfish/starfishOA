...
public interface MonitorService {
	...
	Map<String, Object> getSalePerByYear(String year, String insCode, String tjType);
	...
	List<Plan> getInfPlanAndGamesList();

	List<HistoryRankingModel> getHistoryRankingsList(HistoryForm form);

	Integer getHistoryRankingsCount(HistoryForm form);
