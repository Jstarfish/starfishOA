...
public class InfOrgs implements Serializable {
	...
	public String toString() {
		return "InfOrgs [address=" + address + ", areaCode=" + areaCode + ", c_errcode=" + c_errcode + ", c_errmsg=" + c_errmsg + ", directorAdmin=" + directorAdmin + ", oldorgCode=" + oldorgCode + ", orgCode=" + orgCode + ", orgName=" + orgName + ", orgStatus=" + orgStatus + ", orgType=" + orgType + ", persons=" + persons + ", phone=" + phone + ", superOrg=" + superOrg + ", superOrgName=" + superOrgName + "]";
	}
