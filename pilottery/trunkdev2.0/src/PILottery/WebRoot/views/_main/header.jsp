			...
			<div class="info">
				...
				<td width="200px" class="right">
		        	...
		        	<c:if test="${applicationScope.useCompany == 2}">
		        		<img onclick="switchSystem('pilottery')" src="${basePath}/img/icon4.png" height="24px" width="24px" title="PILottery"/>
			        <img onclick="switchSystem('oms')" src="${basePath}/img/icon3.png" height="24px" width="24px" title="OMS"/>
		        	</c:if>
				</td>
				</tr>
                </table>
