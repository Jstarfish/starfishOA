	...
	$(document).ready(function(){
		...
		$("#okButton").bind("click",function(){
			var result=true;
					...
					$.ajax({
						...
						success : function(r){
					           ...
					           if(r==true){
					        	   ...
					        	   doCheckmessage("orgName",false,"Department name already exists");
										result = false;
			  ...
			  //判断未选择时
		      if(nodes.length==0){
		    	  showError('Please choose one area');
				    return false;
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-top: 10px;padding-bottom: 0px;">
								...
								<tr>
									...
									<td class="td" align="left">
										...
										<span id="phoneTip" class="tip_init">* 1~15 characters</span>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<span id="addressTip" class="tip_init">0~500 characters</span></td>
								</tr>
