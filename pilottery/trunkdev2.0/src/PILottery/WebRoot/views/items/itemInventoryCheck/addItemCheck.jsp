...
function genDynamicBox(value) {
	...
	$.ajax({
		...
		success: function(r) {
            ...
            html += '<th width="24%" align="left">Item Code</th>';
            html += '<th width="2%" align="left">|</th>';
            html += '<th width="24%" align="left">Item Name</th>';
            html += '<th width="2%" align="left">|</th>';
            html += '<th width="24%" align="left">Quantity</th>';
            html += '<th width="2%" align="left">|</th>';
            html += '<th width="*%" style="padding-left:8px;">Tick to Check</th>';
            html += '</tr>';
...
$(document).ready(function(){
    ...
    $("#okButton").bind("click", function(){
        ...
        if (!doCheck("checkName", isNotEmptyString($("#checkName").val()), "Can't be empty")) {
            result = false;
        }
    ...
    <form action="item.do?method=addItemCheck" id="newItemCheckForm" method="POST">
        <div class="pop-body">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
            	...
            	<tr>
					<td align="right" width="25%">Check Warehouse：</td>
					<td align="left" width="30%">
            	...
            	<tr>
					<td align="right" width="25%">Checked By：</td>
					<td align="left" width="30%">
