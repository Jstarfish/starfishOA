                ...
                <table  border="0"  cellpadding="0" cellspacing="0" width="100%;" valign="top">
                  ...
                  <tr>
                    <td style="border-bottom:1px solid #ccc; padding-bottom:10px;"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px; ">
                        <tr>
                          ...
                          <td  class="lz1" style="width: 15%">Issue Code:</td>
                          <td style="width:30%"><select name="doNo" id="doNo" class="select-big" style="width:300px;">
                              <option value=""></option>
                              <c:forEach items ="${salList}"  var ="db">
                                   <option value="${db.doNo}">${db.doNo } (${db.applyAdminName })</option>
                              </c:forEach>
                            </select></td>
                            <td class="lz1" id="info3"></td>
                            <td id="info4"></td>
                            <td id="info5"></td>
                          <td align="left">
                  ...
                  <tr>
                    <td ><!--列表开始-->
                      ...
                      <div class="nr">
                        <div class="title-mbx">List of Goods Issues</div>
                      </div>
                  ...
                  <tr>
                      ...
                      Total Amount :<span class="lz2" id="labnos"></span>riels
                      </div></td>
                       </tr>
                  <tr>
                       <td colspan="4"> 
