...
<script type="text/javascript" src="${basePath}/views/checkTickets/js/TransCodeHandlerForSC_zh.js"></script>
			...
			<div class="tabn">
				...
				<td>
					...
					<div class="nr">
						...
						<div>
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td><input class="edui-editor" id="barcode" type="text" value="请输入条形码" onfocus="this.value=''" onblur="if(this.value==''){this.value='请输入条形码'}"/></td>
                            </tr>
                          </table>
                        </div>
					</div>
					...
					<div style="margin-top:10px; float:right; padding:0 20px;">
						...
						<button class="gl-btn2" type="button" id="okButton">提交</button>
					</div>
				</td>
				</tr>
				</table>
