...
<script type="text/javascript">
	...
	function changeBatch(){
		...
		$('#batch').empty();
		$('#tree').empty();
		$('#batch').append("<option value=''>--请选择--</option>"); 
		if(planCode == ''){
			return false;
		}
...
<form id="damageForm" action="damegeGood.do?method=damageGoods" method="post">
    <div class="sj" style="margin-top: 50px;width:686px;">
      ...
      <table id="tb1" width="100%" border="0" cellspacing="0" cellpadding="0"  height="580" >
      	 <tr>
		    <td width="120px;" align="right"><span class="lz">原因:</span></td>
		    <td width="*%">&nbsp;&nbsp;
		    	<select id="status" name="status" class="select-big">
		    		<option value=''>--请选择--</option>
               	   	<option value="41">被盗</option>
               	   	<option value="42">损毁</option>
               	   	<option value="43">丢失</option>
		    	</select>
			</td>
		  </tr>
		  <tr>
     ...
     <div class="clear">
        <input type="button" id="okBtn" class="button-normal" style="float:right;" value="提交" onclick="save();"/>
     </div>
</form>
</div>
</div>
