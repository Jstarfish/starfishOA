...
<body>
    ...
    <div class="queryDiv">
        <form action="repaymentRecord.do?method=listRepaymentRecords" id="queryForm" method="post">
            <div class="left">
                <span>日期:
                    <input name="queryDate" value="${form.queryDate }" class="Wdate text-normal" onfocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd',readOnly:true})"/>
                </span>
