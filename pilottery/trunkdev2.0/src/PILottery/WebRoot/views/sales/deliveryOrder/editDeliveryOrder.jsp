...
<body style="text-align:center">
	<form  id="editForm" method="post" action="delivery.do?method=editDeliveryOrder">
                   ...
                   <table id="oltable" class="datatable" cellpadding="0" cellspacing="0" width="100%">
                     <tbody>
                      <c:forEach var="item"	items="${orderList}" varStatus="i">
	                     <tr>
	                       <td style="width:4%">
	                       		<input type="checkbox" name="doRelation[${i.index}].orderNo" value="${item.orderNo}" onchange="sumPlan(this,'${item.orderNo}');" 
                 ...
                 <div style="position:relative; z-index:1000px;">
                   <table class="datatable" id="table1_head" width="100%">
                     <tbody><tr>
                       <th width="20%">Plan </th>
                       <th width="2%">|</th>
                       <th width="20%">Quantity(packs)</th>
                       <th width="2%">|</th>
                       <th width="20%">Quantity(tickets)</th>
                       <th width="2%">|</th>
                       <th width="20%">Amount(riels)</th>
                       <th width="*%">&nbsp;</th>
                     </tr>
                   </tbody></table>
                 </div>
		...
		<div class="pop-footer">
			...
			<span class="right"><input type="button" value="Reset" class="button-normal" onclick="doClose()"></input></span>
		</div>
	</form>
</body>
</html>