...
<body>
	<!-- 充值查询 -->
	 <div id="title">On-Site Inspection</div>
	 <div class="queryDiv">
				...
				<td>
					<table class="datatable">
						<tr class="headRow">
							...
							<th width="1%">|</th>
							<td style="width: 12%">Terminal Code</td>
							<th width="1%">|</th>
							<td style="width: 12%">Inspection Time</td>
							<th width="1%">|</th>
							<td style="width: 15%">Inspection Person</td>
						</tr>
					</table>
				</td>
