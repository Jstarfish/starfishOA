         ...
         <c:forEach var="data" items="${pageDataList}" varStatus="status" >
            ...
            <td style="width:10px;">&nbsp;<input type="hidden" value="${data.operModeId }"></td>
                ...
                <td style="width:20%">${data.operContents }</td>
                 <td width="1%" >&nbsp;</td>
                <td style="width:*%">
                    <span><a href="#" onclick="showBox('operateLog.do?method=initModifyOperateType&operModeId=${data.operModeId }','修改',350,550);">修改</a></span>
                </td>
            </tr>
            </c:forEach>
        </table>
