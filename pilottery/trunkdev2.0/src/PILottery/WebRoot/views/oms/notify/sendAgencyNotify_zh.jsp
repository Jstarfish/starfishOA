...
<div style="position:absolute;top:39px;bottom:0px;width:100%;">
    ...
    <div id="right1">
        ...
        <input name="title" id="txtmsgtitle" tabindex="1" type="text" class="input-text1" maxlength="50" placeholder="长度限50字符">
        <div><span id="txtmsgcontentTip"></span></div>
        <textarea id="txtmsgcontent" name="content" rows="10" class="textarea2" maxlength="200" placeholder="请输入消息内容，长度限200字符"></textarea>
