				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							...
							<td width="37%" align="right"><a href="#"
								onclick="cancel('caption2');" onmouseout="MM_swapImgRestore()"
							...
							<td width="10%" align="right"><a href="#"
								onclick="prompt('caption2');" onmouseout="MM_swapImgRestore()"
			...
			<tr>
				<td class="nr" style="height: 220px">
					<div style="margin: 0 auto; width: 460px;">
						<textarea id="caption2" name="sysDefaultValue" maxlength="100"
							rows="5" class="edui-editor"
							style="width: 465px;height:218px; margin-left: -8; font-size: 35;">${scrollingNotice2}</textarea> 
					</div>
				</td>
			</tr>
		</table>
