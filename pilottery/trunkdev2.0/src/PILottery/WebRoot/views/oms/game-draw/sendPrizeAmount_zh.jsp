	                        ...
	                        <tr>
	                            <td colspan="4" class="tit">
	                                ...
	                                <span style="margin-right:50px;float: right;">
		                                <input type="button" value="编辑" onclick="edit(this)" class="button-normal"></input>
		                                <input type="button" value="重置" onclick="resetAmount()" class="button-normal" class="_text"></input>
	                                </span>
	                            </td>
	                        </tr>
	                        <tr height="10"></tr>
