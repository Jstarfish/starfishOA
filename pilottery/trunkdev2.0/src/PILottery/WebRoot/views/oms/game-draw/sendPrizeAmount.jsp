...
function checkAmounts(id) {
	//var regex1 = /^[0-9]{1,}$/;
	var regex1 = /^[0-9]{1,}$/;
    var result = doCheck(id,regex1,'* incorrect money format');
    return result;
}
	                    ...
	                    <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%;">
	                        <tr>
	                            <td colspan="4" class="tit">
	                                <span style="font-size: 24px;">6. Distribution</span>
                            ...
                            <tr><td colspan="4" align="center" valign="top">
	                            <table border="0" cellpadding="0" cellspacing="0" width="95%" class="tabxian">
		                            <tr class="biaot">
			                            <td width="20%" align="center">Pool Amount:</td>
			                            <td width="20%" align="center">Winning Bets</td>
			                            <td width="*%" align="center">Prize to Distribute</td>
		                            </tr>
