  ...
  <form action="updatePlan.do?method=changeupdatetime" id="editUpdateTime" method="post">
    <div class="pop-body">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td align="right">Upgrade Mode:</td>
          <td align="center">
            <select id="time_type" name="timeType" class="select-big" onchange="changeType()">
              <option value="1">Specified Time</option>
              <option value="2">Update Immediately</option>
            </select>
          </td>
    ...
    <div class="pop-footer">
      <span class="left">
        <input id="okBtn" type="button" value="Submit" onclick="doSubmit();" class="button-normal"></input>
      </span>
      <span class="right">
