...
function doSubmit() {
	...
	if(Number(fdfd) < Number(fdbd)){
		shorError('First-prize lower limit cannot be less than first-prize upper limit');
		return false;
	}
...
<body>
 	<form modelAttribute="gameManagementForm" id="gmForm">
  	...
  	<div class="pop-body">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" >
			...
			<tr>
				...
				<td>
					<input id="fdbd" name="fdbd" class="text-normal" onblur="value=value.replace(/[^0-9]/g,'')" maxlength="11"/>
