...
<body>
 	<div class="pop-body">
        <table class="datatable">
            <tr class="headRow">
               <!-- 弃奖日期 -->
               <td style="width:20%;">Abandon Date</td>
               <!-- 游戏期号 -->
               <td style="width:20%;">Issue Number</td>
               <!-- 弃奖总注数 -->
               <td style="width:20%;">Total Bets</td>
               <!-- 金额 -->
               <td style="width:20%;">Abandon Amount</td>
               <!-- 奖等 -->
               <td style="width:*%;">Prize Level</td>
            </tr>
	...
	<div class="pop-footer" style="position: fixed; left: 0; right: 0;">
        <span class="right">
        	<input type="button" class="button-normal" onclick="closeCur()" value="Close" ></input>
        </span>
    </div>
</body>
</html>
