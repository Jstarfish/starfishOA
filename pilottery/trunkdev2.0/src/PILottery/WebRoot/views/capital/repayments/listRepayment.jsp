    ...
    <div class="queryDiv">
        <form action="repayment.do?method=listRepayment" method="POST" id="repaymentQueryForm">
            <div class="left">
	   			...
	   			<span><input id="repaymentDate" name="repaymentDate" value="${repaymentQueryForm.repaymentDate}" class="Wdate text-normal" onfocus="WdatePicker({lang:'en',dateFmt:'yyyy-MM-dd',readOnly:true,isShowClear:true,isShowToday:true})"/></span>
