				...
				<tr class="dataRow">
					...
					<td style="width: *%">
						...
						<c:if test="${applicationScope.useCompany == 2}">
							<a href="#" onclick="showBox('account.do?method=editInstitutionAccount&orgCode=${data.orgCode }','编辑',550,800);">编辑</a>
						</c:if>
						<c:if test="${applicationScope.useCompany == 1}">
							<a href="#" onclick="showBox('account.do?method=editInstitutionAccount&orgCode=${data.orgCode }','编辑',300,650);">编辑</a>
						</c:if>
						</span>
