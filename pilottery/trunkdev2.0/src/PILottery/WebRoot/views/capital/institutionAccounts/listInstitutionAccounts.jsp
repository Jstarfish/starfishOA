			...
			<c:forEach var="data" items="${pageDataList}" varStatus="status">
				<tr class="dataRow">
					...
					<c:if test="${applicationScope.useCompany == 2}">
						<a href="#" onclick="showBox('account.do?method=editInstitutionAccount&orgCode=${data.orgCode }','Edit',550,800);">Edit</a>
					</c:if>
					<c:if test="${applicationScope.useCompany == 1}">
						<a href="#" onclick="showBox('account.do?method=editInstitutionAccount&orgCode=${data.orgCode }','Edit',300,650);">Edit</a>
					</c:if>	
					</span>
					</td>
				</tr>
