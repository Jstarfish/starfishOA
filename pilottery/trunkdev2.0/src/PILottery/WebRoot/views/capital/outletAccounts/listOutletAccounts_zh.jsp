                ...
                <td style="width:*%">
                    <span>
                    	<c:if test="${applicationScope.useCompany == 2}">
                    		<a href="#" onclick="showBox('account.do?method=editOutletAccount&agencyCode=${data.agencyCode }','编辑',550,800);">编辑</a>
                    	</c:if>
                    	<c:if test="${applicationScope.useCompany == 1}">
                    		<a href="#" onclick="showBox('account.do?method=editOutletAccount&agencyCode=${data.agencyCode }','编辑',300,650);">编辑</a>
                    	</c:if>
                    </span>
                </td>
            </tr>
