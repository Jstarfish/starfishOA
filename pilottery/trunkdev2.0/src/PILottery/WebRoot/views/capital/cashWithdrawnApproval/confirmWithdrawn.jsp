...
<html>
<head>
<title>Confirm Cash Withdrawn</title>
    ...
    <input type="hidden" name="fundNo" value="${withdrawnInfo.fundNo}">
    	<div class="pop-body">
         ...
         <div class="pop-footer">
            <span class="left">
                <input id="okButton" type="submit" value="Submit" class="button-normal"></input>
            </span>
            <span class="right">
