...
function doSubmit(){
	...
	/* if (!doCheck("tellerName", !isNull($("#tellerName").val()), "不能为空")) {
		result = false;
	}  */
		...
		<div class="pop-body">
		    <table width="100%" border="0" cellspacing="0" cellpadding="0" >
		    	...
		    	<tr>
					...
					<td align="center">
						<input class="text-big" name="tellerCode" id="tellerCode" value="" maxlength="8" onkeyup="this.value=this.value.replace(/[^\d,]/g,'')"/>
					</td>
					<td><span id="tellerCodeTip"  class="tip_init">* 非空，数字，长度不超过8</span></td>
				</tr>
				<tr>
					<td align="right">销售员姓名：</td>
					<td align="center"><input name="tellerName" class="text-big" id="tellerName" maxlength="20" isCheckSpecialChar="true" cMaxByteLength="20" /></td>
