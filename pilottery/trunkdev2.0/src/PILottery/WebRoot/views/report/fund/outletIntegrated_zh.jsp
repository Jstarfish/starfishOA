    ...
    <div class="queryDiv">
        <form action="saleReport.do?method=listOutletIntegrated" id="queryForm" method="post">
            <div class="left">
                ...
                <span>日期:
                    <input name="beginDate" value="${form.beginDate }" class="Wdate text-normal" style="width:130px;height:24px;" onfocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd',readOnly:true})"/> 
                </span>
             ...
             <div style="overflow: right;">
	        	<span style="position: absolute;right: 80px;">
	        		<input type="hidden" id="reportTitle" name="reportTitle" value="站点综合查询报表">
                ...
                <td>
                    <table class="datatable" id="exportPdf">
                        <tr class="headRow">
                            ...
                            <td style="width:9%">站点编码</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:9%">所属机构</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:9%">市场管理员</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:9%">充值金额</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:9%">提现金额</td>
                            <td width="1%" noExp="true">|</td>
