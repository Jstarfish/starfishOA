...
<body>
    <!-- 顶部标题块 -->
    <div id="title">Headquarters Inventory Receipt Statistics</div>
            ...
            <div class="left">
             ...
             <div style="overflow: right;">
	        	<span style="position: absolute;right: 80px;">
	        		<input type="hidden" id="reportTitle" name="reportTitle" value="Headquarters Inventory Receipt Statistics">
                ...
                <td>
                    <table class="datatable" id="exportPdf">
                        <tr class="headRow">
                            ...
                            <td width="1%" noExp="true">|</td>
                            <td style="width:12%">Warehouse Code</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:12%">Warehouse Name</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:12%">Tickets</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:12%">Amount(R)</td>
                            <td width="1%" noExp="true">|</td>
    ...
    <div id="bodyDiv">
        ...
        <c:forEach var="obj" items="${receiptsList}" varStatus="status" >
            <tr class="dataRow">
                ...
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:12%;text-align: right"><fmt:formatNumber value="${obj.amount }" /></td>
                <td width="1%" noExp="true">&nbsp;</td>
           ...
           <tr class="dataRow">
                ...
                <td width="1%" noExp="true">&nbsp;</td>
                <td style="width:12%;text-align: right"><fmt:formatNumber value="${goodsReceiptsReportSum.amount }" /></td>
                <td width="1%" noExp="true">&nbsp;</td>
