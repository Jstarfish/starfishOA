...
<title>MM Sales Monthly Report</title>
...
<body>
    <!-- 顶部标题块 -->
    <div id="title">MM Sales Monthly Report</div>
    ...
    <div class="queryDiv">
        <form action="monthlyReport.do?method=listMktManagerMonthlyReport" id="queryForm" method="post">
            <div class="left">
                ...
                <span>Date:
                    <input name="beginDate" value="${form.beginDate }" class="Wdate text-normal" style="width: 130px;height:24px;" onfocus="WdatePicker({lang:'en',dateFmt:'yyyy-MM',maxDate:'%y-{%M}',readOnly:true})"/> 
                    	-
                    <input name="endDate" value="${form.endDate }" class="Wdate text-normal" style="width: 130px;height:24px;" onfocus="WdatePicker({lang:'en',dateFmt:'yyyy-MM',maxDate:'%y-{%M}',readOnly:true})"/>
                </span>
                <input type="submit" value="Query" class="button-normal"></input>
            </div>
             <div style="overflow: right;">
	        	<span style="position: absolute;right: 80px;">
	        		<input type="hidden" id="reportTitle" name="reportTitle" value="MM Sales Monthly Report">
                ...
                <td>
                    <table class="datatable" id="exportPdf">
                        <tr class="headRow">
                        	...
                        	<td style="width:9%" title="Date">Date</td>
                            <td width="1%" noExp="true">|</td>
                        	<td style="width:10%" title="MarketManager">MarketManager</td>
                            <td width="1%" noExp="true">|</td>
                        	<td style="width:10%" title="Institution">Institution</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:10%" title="Top Up">Top Up</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:10%" title="Withdraw">Withdraw</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:10%" title="Sales Amount">Sales Amount</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:10%" title="Payout Amount">Payout Amount</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:10%" title="Return Amount">Return Amount</td>
                            <td width="1%" noExp="true">|</td>
                            <td style="width:*%" title="Net Sales">Net Sales</td>
                        </tr>
                    </table>
                 </td>
                 <!-- 表头和下方数据对齐 -->
