package cls.pilottery.web.institutions.service;
...
public interface InstitutionsService {
  ...
  */
   ...
   * 
      * @Title: getModyTree
      * @Description: 修改组织区域的树形json
      * @param @param listcy
      * @param @param listorgArea
      * @param @return    参数
      * @return String    返回类型
      * @throws
   */
	...
	public List<InfOrgs> getManagementOrgInfo(String userId);
}
