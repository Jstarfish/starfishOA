...
/**
 * 
    * @ClassName: GoodsReceiptsService
    * @Description: 入库管理service
    * @author yuyuanhua
    * @date 2015年9月12日
    *
 */
public interface GoodsReceiptsService {
	/**
	 * 
	...
	/**
	 * 
	    * @Title: getGamePlanInfoByCode
	    * @Description: 获得方案信息
	    * @param @param planCode
	    * @param @return    参数
	    * @return GamePlans    返回类型
	    * @throws
	 */
