...
public class GameIssue extends BaseEntity{
	...
	private String firstDrawUserName;	//第一次开奖用户
	private String secondDrawUserName;	//第二次开奖用户
	...
	public String getFirstDrawUserName() {
		return firstDrawUserName;
	}
	public void setFirstDrawUserName(String firstDrawUserName) {
		this.firstDrawUserName = firstDrawUserName;
	}
	public String getSecondDrawUserName() {
		return secondDrawUserName;
	}
	public void setSecondDrawUserName(String secondDrawUserName) {
		this.secondDrawUserName = secondDrawUserName;
	}
}
