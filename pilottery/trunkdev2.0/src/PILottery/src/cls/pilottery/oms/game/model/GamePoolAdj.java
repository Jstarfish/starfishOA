 ...
 * ISS_GAME_POOL_ADJ
 */
public class GamePoolAdj extends BaseEntity{

	private static final long serialVersionUID = 3182823959625503863L;

	private String poolFlow;	//变更流水
	...
	private Short isAdj;		//变更是否生效
    
	private Integer c_add_now;
	
	public Integer getC_add_now() {
		return c_add_now;
	}
	public void setC_add_now(Integer c_add_now) {
		this.c_add_now = c_add_now;
	}
	...
	public Short getIsAdj() {
		return isAdj;
	}
	public void setIsAdj(Short isAdj) {
		this.isAdj = isAdj;
	}
