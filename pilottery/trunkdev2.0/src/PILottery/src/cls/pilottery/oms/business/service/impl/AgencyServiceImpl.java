...
public class AgencyServiceImpl implements AgencyService{
	...
	public String batchInsertGameAuth(Agency agency) {
		...
		try {
			...
			StructDescriptor sd = new StructDescriptor("TYPE_GAME_AUTH_INFO_TS",
					conn);
	...
	@Override
	public List<Terminal> getTerminalByAgencyCode(String agencycode) {
		return agencyDao.getTerminalByAgencyCode(agencycode);
	}

	@Override
	public List<Teller> getTellerByAgencyCode(String agencycode) {
		return agencyDao.getTellerByAgencyCode(agencycode);
	}

	@Override
	public void clearOutlet(OutletClearInfo info) {
		agencyDao.clearOutlet(info);
	}
