...
public class StartupListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent event){
		try {
		    ...
		    event.getServletContext().setAttribute("useCompany", PropertiesUtil.readValue("useCompany"));
		    event.getServletContext().setAttribute("isTestSystem", PropertiesUtil.readValue("isTestSystem"));
		    event.getServletContext().setAttribute("httpServerPort", Integer.parseInt(PropertiesUtil.readValue("httpServerPort")));
