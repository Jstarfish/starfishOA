...
public class Response4001Model extends BaseResponse {
	...
	private List<Response4001Record> przieInfo;  //奖等中奖信息
	...
	public List<Response4001Record> getPrzieInfo() {
		return przieInfo;
	}
	public void setPrzieInfo(List<Response4001Record> przieInfo) {
		this.przieInfo = przieInfo;
	}
}
