...
public class SystemServiceImpl implements SystemService {
	...
	public BaseResponse login(Object obj) throws Exception{
       ...
       // if(version != null && !version.equals(request.getVersion())){
        if(version != null && !version.contains(request.getVersion())){
        ...
        String isTestSystem = PropertiesUtil.readValue("isTestSystem");
		...
		map.put("flag", Integer.parseInt(isTestSystem));
