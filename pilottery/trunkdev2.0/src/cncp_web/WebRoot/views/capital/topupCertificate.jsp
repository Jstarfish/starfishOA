...
<title>Top Up Certificate</title>
<style>
body {
		...
		<table width="1000" border="0" cellspacing="0" cellpadding="0"
			...
			<tr height="80">
				<td colspan="3"><table width="100%" border="0" cellspacing="0"
						cellpadding="0">
						<tr>
							<td>Operator:${topUpInfo.operAdminName}</td>
				...
				<td colspan="3" style="padding: 20px 0;">
					<table width="1000" border="1" align="center" cellpadding="0"
						...
						<tr align="left" height="80">
							<td width="302" style="padding: 10px;">Dealer Code:&nbsp;&nbsp;${topUpInfo.dealerCode}</td>
							<td colspan="2" style="padding: 10px;">Dealer Name:&nbsp;&nbsp;${topUpInfo.dealerName}</td>
						</tr>
						<tr align="left" height="80">
							<td width="302" style="padding: 10px;">Account Balance:&nbsp;&nbsp;<fmt:formatNumber value="${topUpInfo.afterAccountBalance}" /></td>
							<td style="padding: 10px" colspan="2">Top Up Amount: &nbsp;&nbsp;<fmt:formatNumber value="${topUpInfo.operAmount}" /></td>
						</tr>
						<tr align="left" height="80">
							<td colspan="3" style="padding: 10px;">Time of Top Up:&nbsp;&nbsp;${topUpInfo.operTime}</td>
						</tr>
					</table>
				</td>
			</tr>
