...
<script src="${basePath}/views/capital/js/withdraw.js"></script>
</head>
<body>
	<div class="row base-margin" id="query">
		<ol class="breadcrumb">
			<li><strong><span style="color: #27a0d7">Cash Withdrawn Records</span></strong></li>
		</ol>
		<form class="form-inline" role="form" style="float: left; width: 100%;margin-bottom:0;" method="post" id="queryForm">
			<div class="form-group">
			 ...
			 <div class="form-group btn-right">
				<button type="button" class="btn btn-primary" id="withdraw" onclick="towithdraw();">Cash Withdrawn</button>
			 </div>
		</form>
	</div>
	<div class="container" style="width: 100%">
	    <table id="withdrawRecords-table">
	    </table>
	</div>
</body>
</html>
