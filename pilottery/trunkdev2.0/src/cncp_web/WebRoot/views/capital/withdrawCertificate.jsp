		...
		<table width="1000" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				<td colspan="3"	style="font-size: 24px; line-height: 60px; border-bottom: 2px solid #000; font-weight: bold; 
					text-align: center;">Withdrawn Certificate</td>
			</tr>
			<tr height="80">
				<td colspan="3"><table width="100%" border="0" cellspacing="0"
						cellpadding="0">
						<tr>
							<td>Operator:${withdrawInfo.operAdminName}</td>
				...
				<td colspan="3" style="padding: 20px 0;">
					<table width="1000" border="1" align="center" cellpadding="0"
						...
						<tr align="left" height="80">
							<td width="302" style="padding: 10px;">Dealer Code:&nbsp;&nbsp;${withdrawInfo.dealerCode}</td>
							<td colspan="2" style="padding: 10px;">Dealer Name:&nbsp;&nbsp;${withdrawInfo.dealerName}</td>
						</tr>
						<tr align="left" height="80">
							<td width="302" style="padding: 10px;">Account Balance:&nbsp;&nbsp;<fmt:formatNumber value="${withdrawInfo.afterAccountBalance}" /></td>
							<td style="padding: 10px;" colspan="2">Cash Withdrawn:&nbsp;&nbsp;<fmt:formatNumber value="${withdrawInfo.operAmount}" /></td>
						</tr>
						<tr align="left" height="80">
							<td colspan="3" style="padding: 10px;">Date of Withdrawal:&nbsp;&nbsp;${withdrawInfo.operTime}</td>
						</tr>
					</table>
				</td>
			</tr>
