...
<body style="overflow-x:hidden;">
	<div class="ibox-content ">
        <form action="adjustment.do?method=adjustment" method="post" class="form-horizontal m-t" id="editForm" novalidate="novalidate">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label">调账金额：</label>
                <div class="col-sm-8" style="width:50%;">
