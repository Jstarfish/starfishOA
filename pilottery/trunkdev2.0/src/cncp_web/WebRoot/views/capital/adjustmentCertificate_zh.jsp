		...
		<table width="1000" border="0" cellspacing="0" cellpadding="0"
			...
			<tr height="80">
				<td colspan="3"><table width="100%" border="0" cellspacing="0"
						cellpadding="0">
						<tr>
							<td>操作人:${adjustmentInfo.operAdminName}</td>
				...
				<td colspan="3" style="padding: 20px 0;">
					<table width="1000" border="1" align="center" cellpadding="0"
						...
						<tr align="left" height="80">
							<td width="302" style="padding: 10px;">渠道商编码:&nbsp;&nbsp;${adjustmentInfo.dealerCode}</td>
							<td colspan="2" style="padding: 10px;">渠道商名称:&nbsp;&nbsp;${adjustmentInfo.dealerName}</td>
						</tr>
						<tr align="left" height="80">
							<td width="302" style="padding: 10px;">账户余额:&nbsp;&nbsp;<fmt:formatNumber value="${adjustmentInfo.afterAccountBalance}" /></td>
							<td style="padding: 10px;" colspan="2">调账金额:&nbsp;&nbsp;<fmt:formatNumber value="${adjustmentInfo.operAmount}" /></td>
						</tr>
						<tr align="left" height="80">
							<td colspan="3" style="padding: 10px;">调账时间:&nbsp;&nbsp;${adjustmentInfo.operTime}
							</td>
						</tr>
					</table>
				</td>
