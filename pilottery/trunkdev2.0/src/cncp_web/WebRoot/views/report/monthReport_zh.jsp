...
<head>
    ...
    <script src="${basePath}/views/report/js/monthReport_zh.js"></script>
...
<div class="row base-margin" id="query">
    ...
    <form class="form-inline" role="form" style="float: left; width: 100%" method="post" id="queryForm">
        ...
        <div class="form-group">
            <label >月份:</label>
            <input placeholder="开始月份" class="form-control layer-date" id="startMonth" name="startMonth">
            <input placeholder="结束月份" class="form-control layer-date" id="endMonth" name="endMonth">
        </div>
        <div class="form-group">
