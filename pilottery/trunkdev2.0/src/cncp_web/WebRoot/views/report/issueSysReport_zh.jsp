...
<head>
    ...
    <script src="${basePath}/views/report/js/issueSysReport_zh.js"></script>
...
<div class="row base-margin" id="query">
    <ol class="breadcrumb">
        <li><strong><span style="color: #27a0d7">系统期次销售报表</span></strong></li>
    </ol>
    <form class="form-inline" role="form" style="float: left; width: 100%;margin-bottom:0;" method="post"
          id="queryForm">
			...
			<div class="form-group">
            <label for="issueCode">期次:</label>
            <input type="text" class="form-control" name="issueCode" id="issueCode"
                   placeholder="请输入期次">
        </div>
        <div class="form-group">
