...
<head>
    ...
    <script src="${basePath}/views/report/js/monthReport.js"></script>
...
<div class="row base-margin" id="query">
    <ol class="breadcrumb">
        <li><strong><span style="color: #27a0d7">Monthly Report</span></strong></li>
    </ol>
    <form class="form-inline" role="form" style="float: left; width: 100%" method="post" id="queryForm">
        ...
        <div class="form-group">
            <label >Date:</label>
            <input placeholder="StartDate" class="form-control layer-date" id="startMonth" name="startMonth">
            <input placeholder="EndDate" class="form-control layer-date" id="endMonth" name="endMonth">
        </div>
        <div class="form-group">
