	...
	$.ajax({
	   ...
	   success: function(msg){
	     if(msg=='success'){
	    	 ...
	    	 sweetAlert("The new role error", msg, "error");
	     }
	   }
	});
}
        ...
        <form class="form-horizontal m-t" id="editForm" novalidate="novalidate">
            <div class="form-group">
                ...
                <div class="col-sm-8" style="width:50%;">
                    <input  type="text" class="form-control" id="roleName"name="roleName" maxlength="50" required>
                </div>
            </div>
            <div class="form-group" >
                <label class="col-sm-3 control-label">Remark：</label>
                <div class="col-sm-8" style="width:50%;">
                    <textarea id="remark" name="remark" class="form-control" maxlength="500" required></textarea>
                </div>
            </div>
            <div class="form-group" >
